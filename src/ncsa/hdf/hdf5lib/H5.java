 ...
 * HDF5 library. Each routine wraps a single HDF5 entry point, generally with
 * the arguments and return codes analogous to the C interface.
 * <p>
 ...
 * method will raise an exception instead of returning an error code. See
 ...
 * that reason, the
 * <a href="./ncsa.hdf.hdf5lib.HDFArray.html"><b>HDFArray</b></a> class is used
 * to discover the type, shape, and size of the data array at run time, and to
 ...
 * values are available to Java programs via the class
 * <a href="./ncsa.hdf.hdf5lib.HDF5Constants.html"> <b>HDF5Constants</b></a>.
 * For example, the parameters for the h5open() call include two numeric values,
 ...
 * time by the HDF-5 C library. To support these parameters, the Java class
 * <a href="./ncsa.hdf.hdf5lib.HDF5CDataTypes.html"> <b>HDF5CDataTypes</b></a>
 ...
 * <b>HDF5LibraryException</b></a> and
...
public class H5 implements java.io.Serializable {
	...
	// private final static org.apache.commons.logging.LogFactory. log =
	// org.slf4j.LoggerFactory.getLogger(H5.class);
...
//		}
		...
		if (!isLibraryLoaded) {
			try {
				...
				System.load("/opt/homebrew/Cellar/hdf5/1.14.5/lib/libjhdf5.jnilib");
				isLibraryLoaded = true;
				AppContext.debug(
						"Native code library loaded successfully from../opt/homebrew/Cellar/hdf5/1.14.5/lib/libjhdf5.jnilib" );

			} catch (UnsatisfiedLinkError e) {
				System.err.println("Native code library failed to load.\n /opt/homebrew/Cellar/hdf5/1.14.5/lib/libjhdf5.jnilib" + e);
				System.err.println(e.getMessage());
				e.printStackTrace();
			} catch (Exception e) {
				System.err.println(e.getMessage());
...
// ////////////////////////////////////////////////////////////
	 ...
	 * @return a non-negative value if successful. Upon failure (when the versions
	 *         do not match), this function causes the application to abort (i.e.,
	 *         crash)
	 * 
	...
	/**
	 * H5close flushes all data to disk, closes all file identifiers, and cleans up
	 ...
	 * called before any other HDF function calls, and must be called each time the
	 * library is loaded/linked into the application (the first time and after it's
	 * been unloaded).
	 * <P>
	...
	/**
	 * Turn off error handling By default, the C library prints the error stack of
	 * the HDF-5 C library on stdout. This behavior may be disabled by calling
	 * H5error_off().
	 */
	 ...
	 * 
	 * @param file_export_name The file name to export data into.
	 * @param file_name        The name of the HDF5 file containing the dataset.
	 * @param object_path      The full path of the dataset to be exported.
	 * 
	 * @exception HDF5LibraryException - Error from the HDF-5 Library.
	 **/
...
//////////////////////////////////////////////////////////////
	...
	private synchronized static native int _H5Aclose(int attr_id) throws HDF5LibraryException;

	/**
	 * H5Acopy copies the content of one attribute to another.
	 * 
	 * @param src_aid the identifier of the source attribute
	 * @param dst_aid the identifier of the destination attribute
	 */
	public synchronized static native int H5Acopy(int src_aid, int dst_aid) throws HDF5LibraryException;

	/**
	 * H5Acreate creates an attribute which is attached to the object specified with
	 * loc_id.
	 * 
	 * @deprecated As of HDF5 1.8, replaced by
	 *             {@link #H5Acreate( int, String, int, int, int, int) }
	 * 
	 ...
	 * @param create_plist IN: Identifier of creation property list (currently not
	 *                     used).
	 * 
	 ...
	 **/
	@Deprecated
	public static int H5Acreate(int loc_id, String name, int type_id, int space_id, int create_plist)
	...
	private synchronized static native int _H5Acreate(int loc_id, String name, int type_id, int space_id,
			int create_plist) throws HDF5LibraryException, NullPointerException;
	 ...
	 * 
	 * @return An attribute identifier if successful; otherwise returns a negative
	 *         value.
	 * 
	 * @exception HDF5LibraryException - Error from the HDF-5 Library.
	 * @exception NullPointerException - Name is null.
	...
	/**
	 * H5Acreate2 an attribute, attr_name, which is attached to the object specified
	 ...
	 **/
	private synchronized static native int _H5Acreate2(int loc_id, String attr_name, int type_id, int space_id,
			int acpl_id, int aapl_id) throws HDF5LibraryException, NullPointerException;

	/**
	 * H5Acreate_by_name creates an attribute, attr_name, which is attached to the
	 * object specified by loc_id and obj_name.
	 *
	 * @param loc_id    IN: Location or object identifier; may be dataset or group
	 * @param obj_name  IN: Name, relative to loc_id, of object that attribute is to
	 *                  be attached to
	 * @param attr_name IN: Attribute name
	 * @param type_id   IN: Attribute datatype identifier
	 * @param space_id  IN: Attribute dataspace identifier
	 * @param acpl_id   IN: Attribute creation property list identifier (currently
	 *                  not used).
	 * @param aapl_id   IN: Attribute access property list identifier (currently not
	 *                  used).
	 ...
	 * @exception NullPointerException - name is null.
	 **/
	public static int H5Acreate_by_name(int loc_id, String obj_name, String attr_name, int type_id, int space_id,
			int acpl_id, int aapl_id, int lapl_id) throws HDF5LibraryException, NullPointerException {
	...
	private synchronized static native int _H5Acreate_by_name(int loc_id, String obj_name, String attr_name,
			int type_id, int space_id, int acpl_id, int aapl_id, int lapl_id)
			throws HDF5LibraryException, NullPointerException;

	/**
	 * H5Adelete removes the attribute specified by its name, name, from a dataset,
	...
	/**
	 * H5Adelete_by_idx removes an attribute, specified by its location in an index,
	 * from an object.
	 *
	 * @param loc_id   IN: Location or object identifier; may be dataset or group
	 ...
	 **/
	public synchronized static native void H5Adelete_by_idx(int loc_id, String obj_name, int idx_type, int order,
			long n, int lapl_id) throws HDF5LibraryException, NullPointerException;

	/**
	 * H5Adelete_by_name removes the attribute attr_name from an object specified by
	 ...
	 * @param lapl_id   IN: Link access property list identifier.
	 *
	 * @return a non-negative value if successful; otherwise returns a negative
	 *         value.
	 *
	 * @exception HDF5LibraryException - Error from the HDF-5 Library.
	 * @exception NullPointerException - name is null.
	...
	/**
	 * H5Aexists determines whether the attribute attr_name exists on the object
	 * specified by obj_id.
	 *
	...
	/**
	 * H5Aexists_by_name determines whether the attribute attr_name exists on an
	 * object. That object is specified by its location and name, loc_id and
	 * obj_name, respectively.
	 *
	 * @param loc_id    IN: Location of object to which attribute is attached .
	 * @param obj_name  IN: Name, relative to loc_id, of object that attribute is
	 *                  attached to.
	 * @param attr_name IN: Name of attribute.
	 * @param lapl_id   IN: Link access property list identifier.
	 *
	 * @return boolean true if an attribute with a given name exists, otherwise
	 *         returns false.
	 *
	 * @exception HDF5LibraryException - Error from the HDF-5 Library.
	 * @exception NullPointerException - name is null.
	 **/
	public synchronized static native boolean H5Aexists_by_name(int loc_id, String obj_name, String attr_name,
	 ...
	 * @exception HDF5LibraryException - Error from the HDF-5 Library.
	 **/
	public synchronized static native H5A_info_t H5Aget_info(int attr_id) throws HDF5LibraryException;

	/**
	 * H5Aget_info_by_idx Retrieves attribute information, by attribute index
	 * position.
	 * 
	 * @param loc_id   IN: Location of object to which attribute is attached
	 * @param obj_name IN: Name of object to which attribute is attached, relative
	 *                 to location
	 * @param idx_type IN: Type of index
	 ...
	 * @exception NullPointerException - obj_name is null.
	 **/
	public synchronized static native H5A_info_t H5Aget_info_by_idx(int loc_id, String obj_name, int idx_type,
			int order, long n, int lapl_id) throws HDF5LibraryException, NullPointerException;
	 ...
	 * @exception NullPointerException - obj_name is null.
	 **/
	public synchronized static native H5A_info_t H5Aget_info_by_name(int loc_id, String obj_name, String attr_name,
			int lapl_id) throws HDF5LibraryException, NullPointerException;

	/**
	 * H5Aget_name retrieves the name of an attribute specified by the identifier,
	 * attr_id.
	 * 
	 ...
	 **/
	public synchronized static native long H5Aget_name(int attr_id, long buf_size, String[] name)
			throws ArrayIndexOutOfBoundsException, ArrayStoreException, HDF5LibraryException, NullPointerException,
			IllegalArgumentException;

	public static long H5Aget_name(int attr_id, String[] name) throws ArrayIndexOutOfBoundsException,
			ArrayStoreException, HDF5LibraryException, NullPointerException, IllegalArgumentException {
	...
	/**
	 * H5Aget_name_by_idx retrieves the name of an attribute that is attached to an
	 * object, which is specified by its location and name, loc_id and obj_name,
	 * respectively.
	 * 
	 * @param attr_id  IN: Attribute identifier
	 * @param obj_name IN: Name of object to which attribute is attached, relative
	 ...
	 * @exception NullPointerException - obj_name is null.
	 **/
	public synchronized static native String H5Aget_name_by_idx(int attr_id, String obj_name, int idx_type, int order,
			long n, int lapl_id) throws HDF5LibraryException, NullPointerException;
	 ...
	 **/
	@Deprecated
	public synchronized static native int H5Aget_num_attrs(int loc_id) throws HDF5LibraryException;
	...
	/**
	 * H5Aget_storage_size returns the amount of storage that is required for the
	 * specified attribute, attr_id.
	 * 
	 * @param attr_id IN: Identifier of the attribute to query.
	 * 
	 * @return the amount of storage size allocated for the attribute; otherwise
	 *         returns 0 (zero)
	 * 
	 * @exception HDF5LibraryException - Error from the HDF-5 Library.
	 **/
	public synchronized static native long H5Aget_storage_size(int attr_id) throws HDF5LibraryException;
	 ...
	 * specified an object identifier, object_id.
	 * 
	 ...
	 * @exception NullPointerException - Name is null.
	 **/
	public static int H5Aopen_by_idx(int loc_id, String obj_name, int idx_type, int order, long n, int aapl_id,
			int lapl_id) throws HDF5LibraryException, NullPointerException {
	...
	private synchronized static native int _H5Aopen_by_idx(int loc_id, String obj_name, int idx_type, int order, long n,
			int aapl_id, int lapl_id) throws HDF5LibraryException, NullPointerException;

	/**
	 * H5Aopen_by_name Opens an attribute for an object by object name and attribute
	 * name
	 *
	 * @param loc_id    IN: Location from which to find object to which attribute is
	 *                  attached
	 * @param obj_name  IN: Name of object to which attribute is attached, relative
	 *                  to loc_id
	 * @param attr_name IN: Name of attribute to open
	 ...
	 * @param lapl_id   IN: Link access property list identifier
	 *
	 * @return Returns an attribute identifier if successful; otherwise returns a
	 *         negative value.
	 *
	 * @exception HDF5LibraryException - Error from the HDF-5 Library.
	 * @exception NullPointerException - obj_name is null.
	...
	/**
	 * H5Aopen_idx opens an attribute which is attached to the object specified with
	 * loc_id. The location object may be either a group, dataset, or named
	 * datatype, all of which may have any sort of attribute.
	 * 
	 * @deprecated As of HDF5 1.8, replaced by
	 *             {@link #H5Aopen_by_idx(int, String, int, int, long, int, int) }
	 * 
	 * @param loc_id IN: Identifier of the group, dataset, or named datatype
	 *               attribute
	...
	private synchronized static native int _H5Aopen_idx(int loc_id, int idx) throws HDF5LibraryException;
	...
	/**
	 * H5Aread reads an attribute, specified with attr_id. The attribute's memory
	...
	/**
	 * H5Aread reads an attribute, specified with attr_id. The attribute's memory
	 * datatype is specified with mem_type_id. The entire attribute is read into
	 ...
	 * 
	 * @exception HDF5LibraryException - Error from the HDF-5 Library.
	 * @exception NullPointerException - data buffer is null. See public
	 *                                 synchronized static native int H5Aread( )
	 **/
	...
	/**
	 * H5Arename changes the name of attribute that is attached to the object
	 * specified by loc_id. The attribute named old_attr_name is renamed
	 * new_attr_name.
	 * 
	 * @param loc_id        IN: Location or object identifier; may be dataset or
	 *                      group
	...
	/**
	 * H5Arename_by_name changes the name of attribute that is attached to the
	 * object specified by loc_id and obj_name. The attribute named old_attr_name is
	 * renamed new_attr_name.
	 * 
	 * @param loc_id        IN: Location or object identifier; may be dataset or
	 *                      group
	...
	public synchronized static native int H5Arename_by_name(int loc_id, String obj_name, String old_attr_name,
			String new_attr_name, int lapl_id) throws HDF5LibraryException, NullPointerException;

	/**
	 * H5Awrite writes an attribute, specified with attr_id. The attribute's memory
	 * datatype is specified with mem_type_id. The entire attribute is written from
	 * buf to the file.
	 * 
	 ...
	 **/
	public synchronized static native int H5Awrite(int attr_id, int mem_type_id, byte[] buf)
			throws HDF5LibraryException, NullPointerException;

	/**
	 * H5Awrite writes an attribute, specified with attr_id. The attribute's memory
	 * datatype is specified with mem_type_id. The entire attribute is written from
	 * data object to the file.
	 * 
	 * @param attr_id     IN: Identifier of an attribute to write.
	 * @param mem_type_id IN: Identifier of the attribute datatype (in memory).
	 ...
	 * 
	 * @exception HDF5LibraryException - Error from the HDF-5 Library.
	 * @exception NullPointerException - data object is null. See public
	 *                                 synchronized static native int H5Awrite(int
	 *                                 attr_id, int mem_type_id, byte[] buf);
	 **/
	public synchronized static int H5Awrite(int attr_id, int mem_type_id, Object obj)
			throws HDF5Exception, NullPointerException {
		HDFArray theArray = new HDFArray(obj);
	...
	public synchronized static native int H5AwriteVL(int attr_id, int mem_type_id, String[] buf)
			throws HDF5LibraryException, NullPointerException;
...
//////////////////////////////////////////////////////////////
	 ...
	 */
	public synchronized static native int H5Dcopy(int src_did, int dst_did) throws HDF5LibraryException;
	...
	/**
	 * H5Dcreate creates a data set with a name, name, in the file or in the group
	 * specified by the identifier loc_id.
	 *
	 * @deprecated As of HDF5 1.8, replaced by
	 *             {@link #H5Dcreate(int, String, int, int, int, int, int) }
	 * 
	 * @param loc_id          Identifier of the file or group to create the dataset
	 *                        within.
	 * @param name            The name of the dataset to create.
	 * @param type_id         Identifier of the datatype to use when creating the
	 *                        dataset.
	 * @param space_id        Identifier of the dataspace to use when creating the
	 *                        dataset.
	 ...
	 **/
	@Deprecated
	public static int H5Dcreate(int loc_id, String name, int type_id, int space_id, int create_plist_id)
			throws HDF5LibraryException, NullPointerException {
	...
	private synchronized static native int _H5Dcreate(int loc_id, String name, int type_id, int space_id,
			int create_plist_id) throws HDF5LibraryException, NullPointerException;

	/**
	 * H5Dcreate creates a new dataset named name at the location specified by
	 * loc_id.
	 *
	 ...
	 * @exception NullPointerException - name is null.
	 **/
	public static int H5Dcreate(int loc_id, String name, int type_id, int space_id, int lcpl_id, int dcpl_id,
			int dapl_id) throws HDF5LibraryException, NullPointerException {
	...
	/**
	 * H5Dcreate2 creates a new dataset named name at the location specified by
	 * loc_id.
	 *
	 * @see public static int H5Dcreate(int loc_id, String name, int type_id, int
	 *      space_id, int lcpl_id, int dcpl_id, int dapl_id)
	 **/
	private synchronized static native int _H5Dcreate2(int loc_id, String name, int type_id, int space_id, int lcpl_id,
			int dcpl_id, int dapl_id) throws HDF5LibraryException, NullPointerException;
	 ...
	 * @exception HDF5LibraryException - Error from the HDF-5 Library.
	 **/
	public static int H5Dcreate_anon(int loc_id, int type_id, int space_id, int dcpl_id, int dapl_id)
	...
	private synchronized static native int _H5Dcreate_anon(int loc_id, int type_id, int space_id, int dcpl_id,
			int dapl_id) throws HDF5LibraryException;
	 ...
	 **/
	@Deprecated
	public synchronized static int H5Dextend(int dataset_id, long[] size) throws HDF5Exception, NullPointerException {
		int rval = -1;
	...
	/**
	 * H5Dfill explicitly fills the dataspace selection in memory, space_id, with
	 * the fill value specified in fill.
	 *
	 ...
	 * @param space     IN: Dataspace describing memory buffer and containing the
	 *                  selection to be filled.
	 *
	 * @exception HDF5LibraryException - Error from the HDF-5 Library.
	...
	/**
	 * H5Dget_access_plist returns an identifier for a copy of the dataset access
	 ...
	 * @exception HDF5LibraryException - Error from the HDF-5 Library.
	 **/
	public synchronized static native int H5Dget_access_plist(int dset_id) throws HDF5LibraryException;
	...
	private synchronized static native int _H5Dget_create_plist(int dataset_id) throws HDF5LibraryException;
	 ...
	 * @exception HDF5LibraryException - Error from the HDF-5 Library.
	 **/
	public synchronized static native long H5Dget_offset(int dset_id) throws HDF5LibraryException;
	...
	private synchronized static native int _H5Dget_space(int dataset_id) throws HDF5LibraryException;

	/**
	 * H5Dget_space_status determines whether space has been allocated for the
	 * dataset dset_id.
	 *
	 * @param dset_id IN: Identifier of the dataset to query.
	 *
	 ...
	 * @exception HDF5LibraryException - Error from the HDF-5 Library.
	 **/
	public synchronized static native int H5Dget_space_status(int dset_id) throws HDF5LibraryException;
	...
	private synchronized static native int _H5Dget_space_status(int dset_id, int[] status)
			throws HDF5LibraryException, NullPointerException;

	/**
	 * H5Dget_storage_size returns the amount of storage that is required for the
	 * dataset.
	 * 
	...
	private synchronized static native int _H5Dget_type(int dataset_id) throws HDF5LibraryException;
	 ...
	 *
	 * @param buf      IN/OUT: Pointer to the memory containing the elements to
	 *                 iterate over.
	 ...
	 * @param op_data  IN/OUT: Pointer to any user-efined data for use by operator
	 *                 function.
	 *
	 * @return returns the return value of the first operator that returns a
	 *         positive value, or zero if all members were processed with no
	 *         operator returning non-zero.
	 *
	 * @exception HDF5LibraryException - Error from the HDF-5 Library.
	 * @exception NullPointerException - buf is null.
	 **/
	public synchronized static native int H5Diterate(byte[] buf, int buf_type, int space, H5D_iterate_cb op,
			H5D_iterate_t op_data) throws HDF5LibraryException, NullPointerException;

	/**
	 * H5Dopen opens the existing dataset specified by a location identifier and
	 * name, loc_id and name, respectively.
	 *
	...
	/**
	 * H5Dopen2 opens the existing dataset specified by a location identifier and
	 * name, loc_id and name, respectively.
	 *
	...
	/**
	 * H5Dread reads a (partial) dataset, specified by its identifier dataset_id,
	 * from the file into the application memory buffer buf.
	 * 
	 ...
	 * @param xfer_plist_id Identifier of a transfer property list for this I/O
	 *                      operation.
	 ...
	 * @exception NullPointerException - data buffer is null.
	 **/
	public synchronized static native int H5Dread(int dataset_id, int mem_type_id, int mem_space_id, int file_space_id,
			int xfer_plist_id, byte[] buf, boolean isCriticalPinning) throws HDF5LibraryException, NullPointerException;

	public synchronized static int H5Dread(int dataset_id, int mem_type_id, int mem_space_id, int file_space_id,
	...
	public synchronized static int H5Dread(int dataset_id, int mem_type_id, int mem_space_id, int file_space_id,
			int xfer_plist_id, Object obj) throws HDF5Exception, HDF5LibraryException, NullPointerException {
		return H5Dread(dataset_id, mem_type_id, mem_space_id, file_space_id, xfer_plist_id, obj, true);
	}

	/**
	 * H5Dread reads a (partial) dataset, specified by its identifier dataset_id,
	 * from the file into the application data object.
	 * 
	 * @param dataset_id    Identifier of the dataset read from.
	 * @param mem_type_id   Identifier of the memory datatype.
	 * @param mem_space_id  Identifier of the memory dataspace.
	...
	public synchronized static int H5Dread(int dataset_id, int mem_type_id, int mem_space_id, int file_space_id,
		...
		if (is1D && (dname == 'B')) {
			...
			status = H5Dread_double(dataset_id, mem_type_id, mem_space_id, file_space_id, xfer_plist_id, (double[]) obj,
					isCriticalPinning);
	...
	public synchronized static native int H5Dread_double(int dataset_id, int mem_type_id, int mem_space_id,
			int file_space_id, int xfer_plist_id, double[] buf, boolean isCriticalPinning)
			throws HDF5LibraryException, NullPointerException;

	public synchronized static int H5Dread_double(int dataset_id, int mem_type_id, int mem_space_id, int file_space_id,
	...
	public synchronized static native int H5Dread_float(int dataset_id, int mem_type_id, int mem_space_id,
			int file_space_id, int xfer_plist_id, float[] buf, boolean isCriticalPinning)
			throws HDF5LibraryException, NullPointerException;

	public synchronized static int H5Dread_float(int dataset_id, int mem_type_id, int mem_space_id, int file_space_id,
	...
	public synchronized static native int H5Dread_int(int dataset_id, int mem_type_id, int mem_space_id,
			int file_space_id, int xfer_plist_id, int[] buf, boolean isCriticalPinning)
			throws HDF5LibraryException, NullPointerException;

	public synchronized static int H5Dread_int(int dataset_id, int mem_type_id, int mem_space_id, int file_space_id,
	...
	public synchronized static native int H5Dread_long(int dataset_id, int mem_type_id, int mem_space_id,
			int file_space_id, int xfer_plist_id, long[] buf, boolean isCriticalPinning)
			throws HDF5LibraryException, NullPointerException;

	public synchronized static int H5Dread_long(int dataset_id, int mem_type_id, int mem_space_id, int file_space_id,
	...
	public synchronized static native int H5Dread_reg_ref(int dataset_id, int mem_type_id, int mem_space_id,
			int file_space_id, int xfer_plist_id, String[] buf) throws HDF5LibraryException, NullPointerException;

	public synchronized static native int H5Dread_reg_ref_data(int dataset_id, int mem_type_id, int mem_space_id,
			int file_space_id, int xfer_plist_id, String[] buf) throws HDF5LibraryException, NullPointerException;

	public synchronized static native int H5Dread_short(int dataset_id, int mem_type_id, int mem_space_id,
			int file_space_id, int xfer_plist_id, short[] buf, boolean isCriticalPinning)
			throws HDF5LibraryException, NullPointerException;

	public synchronized static int H5Dread_short(int dataset_id, int mem_type_id, int mem_space_id, int file_space_id,
	...
	public synchronized static native int H5Dread_string(int dataset_id, int mem_type_id, int mem_space_id,
			int file_space_id, int xfer_plist_id, String[] buf) throws HDF5LibraryException, NullPointerException;

	public synchronized static native int H5DreadVL(int dataset_id, int mem_type_id, int mem_space_id,
			int file_space_id, int xfer_plist_id, Object[] buf) throws HDF5LibraryException, NullPointerException;

	/**
	 * H5Dset_extent sets the current dimensions of the chunked dataset dset_id to
	 * the sizes specified in size.
	 *
	 * @param dset_id IN: Chunked dataset identifier.
	 * @param size    IN: Array containing the new magnitude of each dimension of
	 *                the dataset.
	 *
	 * @exception HDF5LibraryException - Error from the HDF-5 Library.
	...
	private synchronized static native int _H5Aopen_by_name(int loc_id, String obj_name, String attr_name, int aapl_id,
			int lapl_id) throws HDF5LibraryException, NullPointerException;
	...
	/**
	 * H5Dvlen_get_buf_size determines the number of bytes required to store the VL
	 * data from the dataset, using the space_id for the selection in the dataset on
	 * disk and the type_id for the memory representation of the VL data in memory.
	 *
...
//int H5Dvlen_get_buf_size(int dset_id, int type_id, int space_id, LongByReference size);
	 ...
	 * @exception NullPointerException - buf is null.
	 **/
	public synchronized static native int H5Dvlen_reclaim(int type_id, int space_id, int xfer_plist_id, byte[] buf)
			throws HDF5LibraryException, NullPointerException;

	/**
	 * H5Dwrite writes a (partial) dataset, specified by its identifier dataset_id,
	 * from the application memory buffer buf into the file.
	 * 
	 * @param dataset_id    Identifier of the dataset read from.
	 * @param mem_type_id   Identifier of the memory datatype.
	 * @param mem_space_id  Identifier of the memory dataspace.
	 ...
	 * @exception NullPointerException - name is null.
	 **/
	public synchronized static native int H5Dwrite(int dataset_id, int mem_type_id, int mem_space_id, int file_space_id,
			int xfer_plist_id, byte[] buf, boolean isCriticalPinning) throws HDF5LibraryException, NullPointerException;

	public synchronized static int H5Dwrite(int dataset_id, int mem_type_id, int mem_space_id, int file_space_id,
			int xfer_plist_id, byte[] buf) throws HDF5LibraryException, NullPointerException {
	...
	/**
	 * H5Dwrite writes a (partial) dataset, specified by its identifier dataset_id,
	 * from the application memory data object into the file.
	 * 
	 * @param dataset_id    Identifier of the dataset read from.
	 * @param mem_type_id   Identifier of the memory datatype.
	 * @param mem_space_id  Identifier of the memory dataspace.
	...
	public synchronized static int H5Dwrite(int dataset_id, int mem_type_id, int mem_space_id, int file_space_id,
		...
		// for variable length Strings
			...
			status = H5DwriteString(dataset_id, mem_type_id, mem_space_id, file_space_id, xfer_plist_id,
					(String[]) obj);
	...
	public synchronized static native int H5Dwrite_double(int dataset_id, int mem_type_id, int mem_space_id,
			int file_space_id, int xfer_plist_id, double[] buf, boolean isCriticalPinning)
			throws HDF5LibraryException, NullPointerException;

	public synchronized static int H5Dwrite_double(int dataset_id, int mem_type_id, int mem_space_id, int file_space_id,
			int xfer_plist_id, double[] buf) throws HDF5LibraryException, NullPointerException {
		return H5Dwrite_double(dataset_id, mem_type_id, mem_space_id, file_space_id, xfer_plist_id, buf, true);
	}

	public synchronized static native int H5Dwrite_float(int dataset_id, int mem_type_id, int mem_space_id,
			int file_space_id, int xfer_plist_id, float[] buf, boolean isCriticalPinning)
			throws HDF5LibraryException, NullPointerException;

	public synchronized static int H5Dwrite_float(int dataset_id, int mem_type_id, int mem_space_id, int file_space_id,
			int xfer_plist_id, float[] buf) throws HDF5LibraryException, NullPointerException {
		return H5Dwrite_float(dataset_id, mem_type_id, mem_space_id, file_space_id, xfer_plist_id, buf, true);
	}

	public synchronized static native int H5Dwrite_int(int dataset_id, int mem_type_id, int mem_space_id,
			int file_space_id, int xfer_plist_id, int[] buf, boolean isCriticalPinning)
			throws HDF5LibraryException, NullPointerException;

	public synchronized static int H5Dwrite_int(int dataset_id, int mem_type_id, int mem_space_id, int file_space_id,
			int xfer_plist_id, int[] buf) throws HDF5LibraryException, NullPointerException {
		return H5Dwrite_int(dataset_id, mem_type_id, mem_space_id, file_space_id, xfer_plist_id, buf, true);
	}

	public synchronized static native int H5Dwrite_long(int dataset_id, int mem_type_id, int mem_space_id,
			int file_space_id, int xfer_plist_id, long[] buf, boolean isCriticalPinning)
			throws HDF5LibraryException, NullPointerException;

	public synchronized static int H5Dwrite_long(int dataset_id, int mem_type_id, int mem_space_id, int file_space_id,
			int xfer_plist_id, long[] buf) throws HDF5LibraryException, NullPointerException {
		return H5Dwrite_long(dataset_id, mem_type_id, mem_space_id, file_space_id, xfer_plist_id, buf, true);
	}

	public synchronized static native int H5Dwrite_short(int dataset_id, int mem_type_id, int mem_space_id,
			int file_space_id, int xfer_plist_id, short[] buf, boolean isCriticalPinning)
			throws HDF5LibraryException, NullPointerException;

	public synchronized static int H5Dwrite_short(int dataset_id, int mem_type_id, int mem_space_id, int file_space_id,
			int xfer_plist_id, short[] buf) throws HDF5LibraryException, NullPointerException {
		return H5Dwrite_short(dataset_id, mem_type_id, mem_space_id, file_space_id, xfer_plist_id, buf, true);
	}

	/**
	 * H5DwriteString writes a (partial) variable length String dataset, specified
	 * by its identifier dataset_id, from the application memory buffer buf into the
	 * file.
	 * 
	...
	public synchronized static native int H5DwriteString(int dataset_id, int mem_type_id, int mem_space_id,
			int file_space_id, int xfer_plist_id, String[] buf) throws HDF5LibraryException, NullPointerException;
...
//////////////////////////////////////////////////////////////
	 ...
	 * error stack conforms to the H5E_auto2_t typedef or the H5E_auto1_t typedef.
	 * 
	 * @param stack_id IN: Error stack identifier.
	 * 
	 * @return boolean true if the error stack conforms to H5E_auto2_t and false if
	 *         it conforms to H5E_auto1_t.
	 * 
	 * @exception HDF5LibraryException - Error from the HDF-5 Library.
	 **/
	public synchronized static native boolean H5Eauto_is_v2(int stack_id) throws HDF5LibraryException;

	/**
	 * H5Eclear clears the error stack for the current thread. H5Eclear can fail if
	 * there are problems initializing the library.
	 * <p>
	 * This may be used by exception handlers to assure that the error condition in
	 * the HDF-5 library has been reset.
	 * 
	...
	/**
	 * H5Eclear clears the error stack specified by estack_id, or, if estack_id is
	 * set to H5E_DEFAULT, the error stack for the current thread.
	 * 
	 * @param stack_id IN: Error stack identifier.
	 * 
	 * @exception HDF5LibraryException - Error from the HDF-5 Library.
	...
	/**
	 * H5Eclear2 clears the error stack specified by estack_id, or, if estack_id is
	 * set to H5E_DEFAULT, the error stack for the current thread.
	 * 
	 * @see #H5Eclear
	 **/
	public synchronized static native void H5Eclear2(int stack_id) throws HDF5LibraryException;

	/**
	 * H5Eclose_msg closes an error message identifier, which can be either a major
	 * or minor message.
	 * 
	 ...
	 * @exception HDF5LibraryException - Error from the HDF-5 Library.
	 **/
	public synchronized static native void H5Eclose_msg(int err_id) throws HDF5LibraryException;

	/**
	 * H5Eclose_stack closes the object handle for an error stack and releases its
	 * resources.
	 * 
	 * @param stack_id IN: Error stack identifier.
	 * 
	 * @exception HDF5LibraryException - Error from the HDF-5 Library.
	 **/
	public synchronized static native void H5Eclose_stack(int stack_id) throws HDF5LibraryException;
	...
	/**
	 * H5Ecreate_stack creates a new empty error stack and returns the new stack's
	 * identifier.
	 * 
	 ...
	 * @exception HDF5LibraryException - Error from the HDF-5 Library.
	 **/
	public synchronized static native int H5Ecreate_stack() throws HDF5LibraryException;
...
// long H5Eget_class_name(int class_id, String name, IntegerType size);
	 ...
	 * @exception HDF5LibraryException - Error from the HDF-5 Library.
	 **/
	public synchronized static native int H5Eget_current_stack() throws HDF5LibraryException;

	/**
	 * H5Eset_current_stack replaces the content of the current error stack with a
	 * copy of the content of the error stack specified by estack_id.
	 * 
	 * @param stack_id IN: Error stack identifier.
	 * 
	 * @exception HDF5LibraryException - Error from the HDF-5 Library.
	 **/
	public synchronized static native void H5Eset_current_stack(int stack_id) throws HDF5LibraryException;

	/**
	 * H5Eget_msg retrieves the error message including its length and type.
	 * 
	 * @param msg_id    IN: Name of the error class.
	 * @param type_list OUT: The type of the error message. Valid values are
	 ...
	 * @exception HDF5LibraryException - Error from the HDF-5 Library.
	 **/
	public synchronized static native String H5Eget_msg(int msg_id, int[] type_list) throws HDF5LibraryException;
// long H5Eget_msg(int msg_id, H5E_TYPE type, String msg, IntegerType size);

	/**
	 * H5Eget_num retrieves the number of error records in the error stack specified
	 ...
	 * @exception HDF5LibraryException - Error from the HDF-5 Library.
	 **/
	public synchronized static native long H5Eget_num(int stack_id) throws HDF5LibraryException, NullPointerException;
	 ...
	 * stream, stream.
	 * 
	 * @param stack_id IN: Error stack identifier.If the identifier is H5E_DEFAULT,
	 *                 the current error stack will be printed.
	 * @param stream   IN: File pointer, or stderr if null.
	 * 
	 * @exception HDF5LibraryException - Error from the HDF-5 Library.
	 **/
	public synchronized static native void H5Eprint2(int stack_id, Object stream) throws HDF5LibraryException;

	/**
	 * H5Epop deletes the number of error records specified in count from the top of
	 * the error stack specified by estack_id (including major, minor messages and
	 * description).
	 * 
	 * @param stack_id IN: Error stack identifier.
	 * @param count    IN: Version of the client library or application to which the
	 *                 error class belongs.
	 * 
	 * @exception HDF5LibraryException - Error from the HDF-5 Library.
	 **/
	public synchronized static native void H5Epop(int stack_id, long count) throws HDF5LibraryException;

	/**
	 * H5Eregister_class registers a client library or application program to the
	 * HDF5 error API so that the client library or application program can report
	 * errors together with HDF5 library.
	 * 
	 * @param cls_name IN: Name of the error class.
	 * @param lib_name IN: Name of the client library or application to which the
	 *                 error class belongs.
	 ...
	 * @exception HDF5LibraryException - Error from the HDF-5 Library.
	 **/
	public synchronized static native void H5Eunregister_class(int class_id) throws HDF5LibraryException;
...
//////////////////////////////////////////////////////////////
	...
	private synchronized static native int _H5Fclose(int file_id) throws HDF5LibraryException;
	...
	private synchronized static native int _H5Fopen(String name, int flags, int access_id)
			throws HDF5LibraryException, NullPointerException;
	...
	private synchronized static native int _H5Freopen(int file_id) throws HDF5LibraryException;
	 ...
	 *                  <LI>H5P_DEFAULT Apply default file access and creation
	 *                  properties.</LI>
	 *                  </UL>
	 * 
	 * @param create_id File creation property list identifier, used when modifying
	 *                  default file meta-data. Use H5P_DEFAULT for default access
	 *                  properties.
	 * @param access_id File access property list identifier. If parallel file
	 *                  access is desired, this is a collective call according to
	 *                  the communicator stored in the access_id (not supported in
	 *                  Java). Use H5P_DEFAULT for default access properties.
	 * 
	 * @return a file identifier if successful
	 * 
	 * @exception HDF5LibraryException - Error from the HDF-5 Library.
	...
	private synchronized static native int _H5Fcreate(String name, int flags, int create_id, int access_id)
			throws HDF5LibraryException, NullPointerException;
	 ...
	 * (memory) cache.
	 * <P>
	 * After this call completes, the file (or object) is in a consistent state and
	 * all data written to date is assured to be permanent.
	 * 
	 ...
	 * @param scope     specifies the scope of the flushing action, in the case that
	 ...
	 * @exception HDF5LibraryException - Error from the HDF-5 Library.
	 **/
	public synchronized static native int H5Fflush(int object_id, int scope) throws HDF5LibraryException;

	/**
	 * H5Fget_access_plist returns the file access property list identifier of the
	 * specified file.
	 * 
	...
	private synchronized static native int _H5Fget_access_plist(int file_id) throws HDF5LibraryException;
	...
	private synchronized static native int _H5Fget_create_plist(int file_id) throws HDF5LibraryException;

	public synchronized static native long H5Fget_filesize(int file_id) throws HDF5LibraryException;

	/**
	 * H5Fget_freespace returns the amount of space that is unused by any objects in
	 * the file.
	 * 
	 ...
	 * @exception HDF5LibraryException - Error from the HDF-5 Library.
	 **/
	public synchronized static native long H5Fget_freespace(int file_id) throws HDF5LibraryException;
	 ...
	 * @exception HDF5LibraryException - Error from the HDF-5 Library.
	 **/
	public synchronized static native int H5Fget_intent(int file_id) throws HDF5LibraryException;
// int H5Fget_intent(int file_id, IntByReference intent);

	/**
	 * H5Fget_mdc_hit_rate queries the metadata cache of the target file to obtain
	 * its hit rate (cache hits / (cache hits + cache misses)) since the last time
	 * hit rate statistics were reset.
	 * 
	 ...
	 * @exception HDF5LibraryException - Error from the HDF-5 Library.
	 **/
	public synchronized static native double H5Fget_mdc_hit_rate(int file_id) throws HDF5LibraryException;

	/**
	 * H5Fget_mdc_size queries the metadata cache of the target file for the desired
	 * size information.
	 * 
	 * @param file_id        IN: Identifier of the target file.
	 * @param metadata_cache OUT: Current metadata cache information
	 *                       <ul>
	 *                       <li>metadata_cache[0] = max_size_ptr // current cache
	 *                       maximum size</li>
	 *                       <li>metadata_cache[1] = min_clean_size_ptr // current
	 *                       cache minimum clean size</li>
	 *                       <li>metadata_cache[2] = cur_size_ptr // current cache
	 *                       size</li>
	 *                       </ul>
	 * 
	 ...
	 * belongs.
	 * 
	 * @param obj_id IN: Identifier of the object for which the associated filename
	 *               is sought.
	 * 
	 * @return the filename.
	 * 
	 * @exception HDF5LibraryException - Error from the HDF-5 Library.
	 **/
	public synchronized static native String H5Fget_name(int obj_id) throws HDF5LibraryException;
// long H5Fget_name(int obj_id, Buffer name/*out*/, long size);

	public synchronized static native String H5Fget_name(int obj_id, int size) throws HDF5LibraryException;
	 ...
	 * @exception HDF5LibraryException - Error from the HDF-5 Library.
	 **/
	public synchronized static native int H5Fget_obj_count(int file_id, int types) throws HDF5LibraryException;
	 ...
	 * @exception HDF5LibraryException - Error from the HDF-5 Library.
	 **/
	public synchronized static native long H5Fget_obj_count_long(int file_id, int types) throws HDF5LibraryException;
	 ...
	 * 
	 * @param file_id     IN: File identifier for a currently-open HDF5 file
	 * @param types       IN: Type of object for which identifiers are to be
	 *                    returned.
	 * @param max_objs    IN: Maximum number of object identifiers to place into
	 *                    obj_id_list.
	 * @param obj_id_list OUT: Pointer to the returned list of open object
	 *                    identifiers.
	 * 
	 * @return the number of objects placed into obj_id_list.
	 * 
	 * @exception HDF5LibraryException - Error from the HDF-5 Library.
	 * @exception NullPointerException - obj_id_list is null.
	 **/
	public synchronized static native int H5Fget_obj_ids(int file_id, int types, int max_objs, int[] obj_id_list)
			throws HDF5LibraryException, NullPointerException;
	...
	/**
	 * H5Fmount mounts the file specified by child_id onto the group specified by
	 * loc_id and name using the mount properties plist_id.
	 * 
	 * @param loc_id   The identifier for the group onto which the file specified by
	 *                 child_id is to be mounted.
	 * @param name     The name of the group onto which the file specified by
	 *                 child_id is to be mounted.
	 ...
	 * @exception NullPointerException - name is null.
	 **/
	public synchronized static native int H5Fmount(int loc_id, String name, int child_id, int plist_id)
			throws HDF5LibraryException, NullPointerException;

	/**
	 * Given a mount point, H5Funmount dissassociates the mount point's file from
	 * the file mounted there.
	 * 
	 * @param loc_id The identifier for the location at which the specified file is
	 *               to be unmounted.
	 ...
	 * @exception HDF5LibraryException - Error from the HDF-5 Library.
	 **/
	public synchronized static native void H5Freset_mdc_hit_rate_stats(int file_id) throws HDF5LibraryException;
...
// ////////////////////////////////////////////////////////////
	...
	private synchronized static native int _H5Gclose(int group_id) throws HDF5LibraryException;
	 ...
	 * 
	 * @deprecated As of HDF5 1.8, replaced by
	 *             {@link #H5Gcreate(int, String, int, int, int) }
	 * 
	 * @param loc_id    The file or group identifier.
	 * @param name      The absolute or relative name of the new group.
	 * @param size_hint An optional parameter indicating the number of bytes to
	...
	private synchronized static native int _H5Gcreate(int loc_id, String name, long size_hint)
			throws HDF5LibraryException, NullPointerException;
	 ...
	 * @param gapl_id IN: Identifier of group access property list. (No group access
	 ...
	 * @exception NullPointerException - name is null.
	 **/
	public static int H5Gcreate(int loc_id, String name, int lcpl_id, int gcpl_id, int gapl_id)
			throws HDF5LibraryException, NullPointerException {
	...
	private synchronized static native int _H5Gcreate2(int loc_id, String name, int lcpl_id, int gcpl_id, int gapl_id)
			throws HDF5LibraryException, NullPointerException;

	/**
	 * H5Gcreate_anon creates a new empty group in the file specified by loc_id.
	 * 
	 * @param loc_id  IN: File or group identifier specifying the file in which the
	...
	private synchronized static native int _H5Gcreate_anon(int loc_id, int gcpl_id, int gapl_id)
			throws HDF5LibraryException;

	/**
	 * H5Gget_comment retrieves the comment for the the object name. The comment is
	 * returned in the buffer comment.
	 * 
	 ...
	 **/
	@Deprecated
	public synchronized static native int H5Gget_comment(int loc_id, String name, int bufsize, String[] comment)
			throws ArrayIndexOutOfBoundsException, ArrayStoreException, HDF5LibraryException, NullPointerException,
			IllegalArgumentException;
	 ...
	 **/
	@Deprecated
	public synchronized static native int H5Gset_comment(int loc_id, String name, String comment)
			throws HDF5LibraryException, NullPointerException;
	 ...
	 * @exception HDF5LibraryException - Error from the HDF-5 Library.
	 **/
	public synchronized static native int H5Gget_create_plist(int group_id) throws HDF5LibraryException;

	/**
	 * H5Gget_info retrieves information about the group specified by group_id. The
	 * information is returned in the group_info struct.
	 * 
	 * @param group_id IN: Identifier of the group.
	 * 
	 ...
	 * @exception HDF5LibraryException - Error from the HDF-5 Library.
	 **/
	public synchronized static native H5G_info_t H5Gget_info(int group_id) throws HDF5LibraryException;
// int H5Gget_info(int loc_id, H5G_info_t ginfo);
	 ...
	 * @exception NullPointerException - name is null.
	 **/
	public synchronized static native H5G_info_t H5Gget_info_by_idx(int group_id, String group_name, int idx_type,
			int order, long n, int lapl_id) throws HDF5LibraryException, NullPointerException;
...
// lapl_id);
	...
	/**
	 * H5Gget_info_by_name retrieves information about the group group_name located
...
// lapl_id);
	...
	/**
	 * H5Gget_linkval returns size characters of the link value through the value
	 * argument if loc_id (a file or group identifier) and name specify a symbolic
	 * link.
	 * 
	 * @param loc_id IN: Identifier of the file, group, dataset, or datatype.
	 ...
	 * 
	 * @deprecated As of HDF5 1.8, replaced by
	 *             {@link #H5Lget_val(int, String, String[] , int)}
	 **/
	@Deprecated
	public synchronized static native int H5Gget_linkval(int loc_id, String name, int size, String[] value)
			throws ArrayIndexOutOfBoundsException, ArrayStoreException, HDF5LibraryException, NullPointerException,
			IllegalArgumentException;
	 ...
	 * @param objRef   OUT: Reference number of all objects under the group, name.
	 * 
	 ...
	 * @exception NullPointerException - name is null.
	 */
	public synchronized static int H5Gget_obj_info_all(int loc_id, String name, String[] objNames, int[] objTypes,
	...
	public synchronized static int H5Gget_obj_info_all(int loc_id, String name, String[] oname, int[] otype,
	...
	public synchronized static int H5Gget_obj_info_full(int loc_id, String name, String[] oname, int[] otype,
			int[] ltype, long[] fno, long[] ref, int indx_type, int indx_order)
			throws HDF5LibraryException, NullPointerException {
		if (oname == null) {
	...
	private synchronized static native int H5Gget_obj_info_full(int loc_id, String name, String[] oname, int[] otype,
			int[] ltype, long[] fno, long[] ref, int n, int indx_type, int indx_order)
			throws HDF5LibraryException, NullPointerException;

	/**
	 * H5Gget_obj_info_idx report the name and type of object with index 'idx' in a
	 * Group. The 'idx' corresponds to the index maintained by H5Giterate. Each link
	 * is returned, so objects with multiple links will be counted once for each
	 * link.
	 * 
	 ...
	 * @exception NullPointerException - name is null.
	 */
	public synchronized static int H5Gget_obj_info_idx(int loc_id, String name, int idx, String[] oname, int[] type)
			throws HDF5LibraryException, NullPointerException {
	...
	/*
	 * //////////////////////////////////////////////////////////////////////////
	 * /////// // // //Add these methods so that we don't need to call //in a loop
	 * to get information for all the object in a group, which takes //a lot of time
	 * to finish if the number of objects is more than 10,000 //
	 * ///////////////////////////////////////////
	 * //////////////////////////////////////
	 */
	/**
	 * retrieves information of all objects (recurvisely) under the group (name)
	 * located in the file or group specified by loc_id upto maximum specified by
	 * objMax.
	 * 
	 * @param loc_id   IN: File or group identifier
	 * @param objNames OUT: Names of all objects under the group, name.
	 * @param objTypes OUT: Types of all objects under the group, name.
	 * @param lnkTypes OUT: Types of all links under the group, name.
	 * @param objRef   OUT: Reference number of all objects under the group, name.
	 ...
	 * @exception NullPointerException - name is null.
	 */
	public synchronized static int H5Gget_obj_info_max(int loc_id, String[] objNames, int[] objTypes, int[] lnkTypes,
			long[] objRef, int objMax) throws HDF5LibraryException, NullPointerException {
		if (objNames == null) {
	...
	private synchronized static native int H5Gget_obj_info_max(int loc_id, String[] oname, int[] otype, int[] ltype,
			long[] ref, int amax, int n) throws HDF5LibraryException, NullPointerException;
	 ...
	 * 
	 * @return a non-negative value if successful, with the fields of link_info and
	 *         mtime (if non-null) initialized.
	 * 
	 * @exception HDF5LibraryException     - Error from the HDF-5 Library.
	 * @exception NullPointerException     - name or array is null.
	 * @exception IllegalArgumentException - bad argument.
	 * 
	 * @deprecated As of HDF5 1.8, replaced by {@link #H5Lget_info(int, String, int)
	 *             and #H5Oget_info(int)}
	 **/
	@Deprecated
	public synchronized static native int H5Gget_objinfo(int loc_id, String name, boolean follow_link, long[] fileno,
			long[] objno, int[] link_info, long[] mtime)
			throws HDF5LibraryException, NullPointerException, IllegalArgumentException;
	 ...
	 * @param name        IN: Name of the object for which status is being sought.
	 * @param follow_link IN: Link flag.
	 * @param info        OUT: the HDF5GroupInfo object to store the object
	 *                    infomation
	 * 
	 * @return a non-negative value if successful, with the fields of HDF5GroupInfo
	 *         object (if non-null) initialized.
	 * 
	 * @exception HDF5LibraryException - Error from the HDF-5 Library.
	 * @exception NullPointerException - name is null.
	 * 
	 ...
	 **/
	@Deprecated
	public synchronized static int H5Gget_objinfo(int loc_id, String name, boolean follow_link, HDF5GroupInfo info)
			throws HDF5LibraryException, NullPointerException {
		int status = -1;
	 ...
	 */
	@Deprecated
	public synchronized static native long H5Gget_objname_by_idx(int group_id, long idx, String[] name, long size)
			throws HDF5LibraryException, NullPointerException;
	 ...
	 *                     <LI>H5G_LINK_SOFT.</LI>
	 *                     </UL>
	 * @param current_name A name of the existing object if link is a hard link. Can
	 *                     be anything for the soft link.
	 ...
	 **/
	@Deprecated
	public synchronized static native int H5Glink(int loc_id, int link_type, String current_name, String new_name)
			throws HDF5LibraryException, NullPointerException;
	 ...
	 **/
	@Deprecated
	public synchronized static native int H5Glink2(int curr_loc_id, String current_name, int link_type, int new_loc_id,
			String new_name) throws HDF5LibraryException, NullPointerException;
	 ...
	 * unlinked from the group graph and the new name, dst, is inserted as an atomic
	 * operation. Both names are interpreted relative to loc_id, which is either a
	 * file or a group identifier.
	 * 
	 ...
	 * 
	 * @deprecated As of HDF5 1.8, replaced by
	 *             {@link #H5Lmove(int, String, int,String, int, int)}
	 **/
	@Deprecated
	public synchronized static native int H5Gmove(int loc_id, String src, String dst)
			throws HDF5LibraryException, NullPointerException;
...
// The interface is preserved as a convenience to existing code.
	/**
	 * H5Gn_members report the number of objects in a Group. The 'objects' include
	 * everything that will be visited by H5Giterate. Each link is returned, so
	 * objects with multiple links will be counted once for each link.
	 * 
	 ...
	 * 
	 * @param loc_id  IN: File or group identifier specifying the location of the
	 *                group to be opened.
	...
	private synchronized static native int _H5Gopen2(int loc_id, String name, int gapl_id)
			throws HDF5LibraryException, NullPointerException;
...
//////////////////////////////////////////////////////////////
	...
	public synchronized static native int H5Iget_file_id(int obj_id) throws HDF5LibraryException;

	public synchronized static native long H5Iget_name(int obj_id, String[] name, long size)
			throws HDF5LibraryException, NullPointerException;

	public synchronized static native int H5Iget_ref(int obj_id) throws HDF5LibraryException, NullPointerException;

	public synchronized static native int H5Idec_ref(int obj_id) throws HDF5LibraryException, NullPointerException;

	public synchronized static native int H5Iinc_ref(int obj_id) throws HDF5LibraryException, NullPointerException;
	 ...
	 * @exception HDF5LibraryException - Error from the HDF-5 Library.
	 **/
	public synchronized static native int H5Iget_type(int obj_id) throws HDF5LibraryException;

	/**
	 * H5Iget_type_ref retrieves the reference count on an ID type. The reference
	 * count is used by the library to indicate when an ID type can be destroyed.
	 * 
	 * @param type IN: The identifier of the type whose reference count is to be
	 *             retrieved
	 * 
	 ...
	 * @exception HDF5LibraryException - Error from the HDF-5 Library.
	 **/
	public synchronized static native int H5Iget_type_ref(int type) throws HDF5LibraryException;

	/**
	 * H5Inmembers returns the number of identifiers of the identifier type
	 * specified in type.
	 * 
	 * @param type IN: Identifier for the identifier type whose member count will be
	 *             retrieved
	 * 
	 ...
	 * @exception HDF5LibraryException - Error from the HDF-5 Library.
	 **/
	public synchronized static native int H5Inmembers(int type) throws HDF5LibraryException;
...
// //////////////////////////////////////////////////////////////////
	...
	public synchronized static native int H5INcreate(String grp_name, int grp_loc_id, int property_list,
			int data_loc_id, String data_loc_name, String field_name, long max_mem_size);

	public synchronized static native int H5INquery(int dset_id, String keys[], Object ubounds, Object lbounds,
			int nkeys);
...
// //////////////////////////////////////////////////////////////////
	 ...
	 * @param dst_loc  IN: Location identifier specifying the destination of the
	 *                 copy
	 ...
	 * @exception NullPointerException - name is null.
	 **/
	public synchronized static native void H5Lcopy(int src_loc, String src_name, int dst_loc, String dst_name,
			int lcpl_id, int lapl_id) throws HDF5LibraryException, NullPointerException;

	/**
	 * H5Lcreate_external creates a new soft link to an external object, which is an
	 ...
	 * @exception NullPointerException - name is null.
	 **/
	public synchronized static native void H5Lcreate_external(String file_name, String obj_name, int link_loc_id,
			String link_name, int lcpl_id, int lapl_id) throws HDF5LibraryException, NullPointerException;

	/**
	 * H5Lcreate_hard creates a new hard link to a pre-existing object in an HDF5
	 * file.
	 *
	 ...
	 **/
	public synchronized static native void H5Lcreate_hard(int cur_loc, String cur_name, int dst_loc, String dst_name,
			int lcpl_id, int lapl_id) throws HDF5LibraryException, NullPointerException;

	/**
	 * H5Lcreate_soft creates a new soft link to an object in an HDF5 file.
	 *
	 * @param link_target IN: Path to the target object, which is not required to
	 *                    exist.
	 * @param link_loc_id IN: The file or group identifier for the new link.
	 * @param link_name   IN: The name of the new link.
	 * @param lcpl_id     IN: Link creation property list identifier
	 ...
	 **/
	public synchronized static native void H5Lcreate_soft(String link_target, int link_loc_id, String link_name,
			int lcpl_id, int lapl_id) throws HDF5LibraryException, NullPointerException;
	...
	/**
	 * H5Ldelete_by_idx removes the nth link in a group according to the specified
	 * order and in the specified index.
	 *
	 * @param loc_id     IN: File or group identifier specifying location of subject
	 *                   group
	 ...
	 **/
	public synchronized static native void H5Ldelete_by_idx(int loc_id, String group_name, int idx_type, int order,
			long n, int lapl_id) throws HDF5LibraryException, NullPointerException;
	 ...
	 * @exception NullPointerException - name is null.
	 **/
	public synchronized static native H5L_info_t H5Lget_info(int loc_id, String name, int lapl_id)
			throws HDF5LibraryException, NullPointerException;

	/**
	 * H5Lget_info_by_idx opens a named datatype at the location specified by loc_id
	 * and return an identifier for the datatype.
	 *
	 * @param loc_id     IN: File or group identifier specifying location of subject
	 *                   group
	 * @param group_name IN: Name of subject group
	 ...
	 * @exception NullPointerException - group_name is null.
	 **/
	public synchronized static native H5L_info_t H5Lget_info_by_idx(int loc_id, String group_name, int idx_type,
			int order, long n, int lapl_id) throws HDF5LibraryException, NullPointerException;
	 ...
	 * @exception NullPointerException - group_name is null.
	 **/
	public synchronized static native String H5Lget_name_by_idx(int loc_id, String group_name, int idx_type, int order,
			long n, int lapl_id) throws HDF5LibraryException, NullPointerException;
	 ...
	 * @param link_value OUT: Path of the symbolic link, or the file_name and path
	 *                   of an external file.
	 * @param lapl_id    IN: Link access property list identifier
	 *
	...
	/**
	 * H5Lget_val_by_idx retrieves value of the nth link in a group, according to
	 ...
	 * @exception NullPointerException - group_name is null.
	 **/
	public synchronized static native int H5Lget_val_by_idx(int loc_id, String group_name, int idx_type, int order,
			long n, String[] link_value, int lapl_id) throws HDF5LibraryException, NullPointerException;
	 ...
	 * @param op       IN: Callback function passing data regarding the link to the
	 *                 calling application
	 ...
	 * @exception HDF5LibraryException - Error from the HDF-5 Library.
	 **/
	public synchronized static native int H5Literate(int grp_id, int idx_type, int order, long idx, H5L_iterate_cb op,
	 ...
	 * @param order      IN: Order of iteration within index
	 * @param idx        IN: Iteration position at which to start
	 * @param op         IN: Callback function passing data regarding the link to
	 ...
	 * @exception NullPointerException - group_name is null.
	 **/
	public synchronized static native int H5Literate_by_name(int grp_id, String group_name, int idx_type, int order,
			long idx, H5L_iterate_cb op, H5L_iterate_t op_data, int lapl_id)
			throws HDF5LibraryException, NullPointerException;
	 ...
	 * @param lcpl_id  IN: Link creation property list identifier to be associated
	 *                 with the new link.
	 * @param lapl_id  IN: Link access property list identifier to be associated
	 *                 with the new link.
	 *
	 * @exception HDF5LibraryException - Error from the HDF-5 Library.
	 * @exception NullPointerException - name is null.
	 **/
	public synchronized static native void H5Lmove(int src_loc, String src_name, int dst_loc, String dst_name,
			int lcpl_id, int lapl_id) throws HDF5LibraryException, NullPointerException;
	 ...
	 * @exception HDF5LibraryException - Error from the HDF-5 Library.
	 **/
	public synchronized static native int H5Lvisit(int grp_id, int idx_type, int order, H5L_iterate_cb op,
			H5L_iterate_t op_data) throws HDF5LibraryException;
	 ...
	 * @exception NullPointerException - group_name is null.
	 **/
	public synchronized static native int H5Lvisit_by_name(int loc_id, String group_name, int idx_type, int order,
			H5L_iterate_cb op, H5L_iterate_t op_data, int lapl_id) throws HDF5LibraryException, NullPointerException;
...
//////////////////////////////////////////////////////////////
	...
	private synchronized static native int _H5Oclose(int object_id) throws HDF5LibraryException;

	/**
	 * H5Ocopy copies the group, dataset or named datatype specified from the file
	 * or group specified by source location to the destination location.
	 *
	 * @param src_loc_id IN: Object identifier indicating the location of the source
	 *                   object to be copied
	 ...
	 * @exception NullPointerException - name is null.
	 **/
	public synchronized static native void H5Ocopy(int src_loc_id, String src_name, int dst_loc_id, String dst_name,
			int ocpypl_id, int lcpl_id) throws HDF5LibraryException, NullPointerException;
	 ...
	 * @exception HDF5LibraryException - Error from the HDF-5 Library.
	 **/
	public synchronized static native String H5Oget_comment(int obj_id) throws HDF5LibraryException;
	 ...
	 **/
	@Deprecated
	public synchronized static native void H5Oset_comment(int obj_id, String comment) throws HDF5LibraryException;
	 ...
	 * @param name    IN: Relative name of the object whose comment is to be set or
	 *                reset.
	 * @param lapl_id IN: Link access property list identifier.
	 *
	 * @return the comment
...
//long H5Oget_comment_by_name(int loc_id, String name, String comment, long bufsize, int lapl_id);
	 ...
	 **/
	@Deprecated
	public synchronized static native void H5Oset_comment_by_name(int loc_id, String name, String comment, int lapl_id)
			throws HDF5LibraryException, NullPointerException;
	...
	/**
	 * H5Oget_info_by_idx retrieves the metadata for an object, identifying the
	 * object by an index position.
	 *
	 * @param loc_id     IN: File or group identifier
	 * @param group_name IN: Name of group, relative to loc_id, in which object is
	 *                   located
	 * @param idx_type   IN: Type of index by which objects are ordered
	 * @param order      IN: Order of iteration within index
	 * @param n          IN: Object to open
	 * @param lapl_id    IN: Access property list identifier for the link pointing
	 *                   to the object (Not currently used; pass as H5P_DEFAULT.)
	 *
	 * @return object information
	 *
	 * @exception HDF5LibraryException - Error from the HDF-5 Library.
	 * @exception NullPointerException - name is null.
	 **/
	public synchronized static native H5O_info_t H5Oget_info_by_idx(int loc_id, String group_name, int idx_type,
			int order, long n, int lapl_id) throws HDF5LibraryException, NullPointerException;

	/**
	 * H5Oget_info_by_name retrieves the metadata for an object, identifying the
	 * object by location and relative name.
	 *
	 * @param loc_id  IN: File or group identifier specifying location of group in
	 *                which object is located
	 * @param name    IN: Relative name of group
	 * @param lapl_id IN: Access property list identifier for the link pointing to
	 *                the object (Not currently used; pass as H5P_DEFAULT.)
	 *
	 * @return object information
	 *
	 * @exception HDF5LibraryException - Error from the HDF-5 Library.
	 ...
	 * @param new_loc_id IN: File or group identifier specifying location at which
	 ...
	 * @exception NullPointerException - name is null.
	 **/
	public synchronized static native void H5Olink(int obj_id, int new_loc_id, String new_name, int lcpl_id,
			int lapl_id) throws HDF5LibraryException, NullPointerException;

	/**
	 * H5Oopen opens a group, dataset, or named datatype specified by a location and
	 * a path name.
	 *
	 * @param loc_id  IN: File or group identifier
	...
	private synchronized static native int _H5Oopen(int loc_id, String name, int lapl_id)
			throws HDF5LibraryException, NullPointerException;

	/**
	 * H5Ovisit recursively visits all objects accessible from a specified object.
	 *
	 * @param obj_id   IN: Identifier of the object at which the recursive iteration
	 *                 begins.
	 * @param idx_type IN: Type of index
	 * @param order    IN: Order of iteration within index
	 * @param op       IN: Callback function passing data regarding the object to
	 *                 the calling application
	 * @param op_data  IN: User-defined pointer to data required by the application
	 ...
	 * @exception NullPointerException - name is null.
	 **/
	public synchronized static native int H5Ovisit(int obj_id, int idx_type, int order, H5O_iterate_cb op,
	 ...
	 * @exception NullPointerException - name is null.
	 **/
	public synchronized static native int H5Ovisit_by_name(int loc_id, String obj_name, int idx_type, int order,
			H5O_iterate_cb op, H5O_iterate_t op_data, int lapl_id) throws HDF5LibraryException, NullPointerException;
...
//      throws HDF5LibraryException, NullPointerException;
	...
	private synchronized static native int _H5Pcopy(int plist) throws HDF5LibraryException;
	 ...
	 * @throws HDF5LibraryException
	 */
	public synchronized static native int H5Pcopy_prop(int dst_id, int src_id, String name) throws HDF5LibraryException;
	...
	private synchronized static native int _H5Pcreate(int type) throws HDF5LibraryException;
	 ...
	 * @return a positive value if the property exists in the property object; zero
	 *         if the property does not exist; a negative value if failed
	 * @throws HDF5LibraryException
	 */
	 ...
	 * @throws HDF5LibraryException
	 */
	public synchronized static native int H5Pset(int plid, String name, int value) throws HDF5LibraryException;

	/**
	 * H5Pget_alignment retrieves the current settings for alignment properties from
	 ...
	 **/
	public synchronized static native int H5Pget_alignment(int plist, long[] alignment)
			throws HDF5LibraryException, NullPointerException, IllegalArgumentException;

	/**
	 * H5Pset_alignment sets the alignment properties of a file access property list
	 * so that any file object >= THRESHOLD bytes will be aligned on an address
	 ...
	 * @exception HDF5LibraryException - Error from the HDF-5 Library.
	 **/
	public synchronized static native int H5Pset_alignment(int plist, long threshold, long alignment)
			throws HDF5LibraryException;
	...
	/**
	 * H5Pget_attr_creation_order retrieves the settings for tracking and indexing
	 * attribute creation order on an object
	 * 
	 * @param ocpl_id IN: Object (group or dataset) creation property list
	 *                identifier
	 * 
	 ...
	 * 
	 **/
	public synchronized static native int H5Pget_attr_creation_order(int ocpl_id) throws HDF5LibraryException;

	/**
	 * H5Pset_attr_creation_order sets flags specifying whether to track and index
	 * attribute creation order on an object.
	 * 
	 ...
	 * 
	 * @param ocpl_id    IN: : Object (dataset or group) creation property list
	 *                   identifier
	 * @param attributes The maximun and minimum no. of attributes to be stored.
	 *
	 *                   <pre>
	...
	*      attributes[1] =  The minimum number of attributes to be stored in dense storage
	 ...
	 **/
	public synchronized static native int H5Pget_btree_ratios(int plist_id, double[] left, double[] middle,
			double[] right) throws HDF5LibraryException, NullPointerException;

	/**
	 * H5Pset_btree_ratio Sets B-tree split ratios for a dataset transfer property
	 * list. The split ratios determine what percent of children go in the first
	 * node when a node splits.
	 * 
	 * @param plist_id IN Dataset transfer property list
	 ...
	 * @exception HDF5LibraryException - Error from the HDF-5 Library.
	 **/
	public synchronized static native int H5Pset_btree_ratios(int plist_id, double left, double middle, double right)
			throws HDF5LibraryException;

	/**
	 * HH5Pget_buffer gets type conversion and background buffers. Returns buffer
	 * size, in bytes, if successful; otherwise 0 on failure.
	 * 
	 ...
	 **/
	public synchronized static native int H5Pget_buffer(int plist, byte[] tconv, byte[] bkg)
			throws HDF5LibraryException, IllegalArgumentException;
	...
	/**
	 * H5Pset_buffer sets type conversion and background buffers. status to TRUE or
	 * FALSE.
	 * 
	 * Given a dataset transfer property list, H5Pset_buffer sets the maximum size
	 * for the type conversion buffer and background buffer and optionally supplies
	 * pointers to application-allocated buffers. If the buffer size is smaller than
	 * the entire amount of data being transferred between the application and the
	 * file, and a type conversion buffer or background buffer is required, then
	 * strip mining will be used.
	 * 
	 * Note that there are minimum size requirements for the buffer. Strip mining
	 * can only break the data up along the first dimension, so the buffer must be
	 * large enough to accommodate a complete slice that encompasses all of the
	 * remaining dimensions. For example, when strip mining a 100x200x300 hyperslab
	 * of a simple data space, the buffer must be large enough to hold 1x200x300
	 * data elements. When strip mining a 100x200x300x150 hyperslab of a simple data
	...
	/**
	 * Retrieves the maximum possible number of elements in the meta data cache and
	 * the maximum possible number of bytes and the RDCC_W0 value in the raw data
	 * chunk cache.
	 * 
	 * @param plist       IN: Identifier of the file access property list.
	 * @param mdc_nelmts  IN/OUT: No longer used, will be ignored.
	 * @param rdcc_nelmts IN/OUT: Number of elements (objects) in the raw data chunk
	 *                    cache.
	 ...
	 **/
	public synchronized static native int H5Pget_cache(int plist, int[] mdc_nelmts, long[] rdcc_nelmts,
			long[] rdcc_nbytes, double[] rdcc_w0) throws HDF5LibraryException, NullPointerException;

	/**
	 * @deprecated As of HDF5 1.8, replaced by
	 *             {@link #H5Pget_cache(int, int[], long[], long[], double[]) }
	 *             because of possible loss of precision
	 **/
	@Deprecated
	public static int H5Pget_cache(int plist, int[] mdc_nelmts, int[] rdcc_nelmts, int[] rdcc_nbytes, double[] rdcc_w0)
			throws HDF5LibraryException, NullPointerException {
	...
	/**
	 * H5Pset_cache sets the number of elements (objects) in the meta data cache and
	 * the total number of bytes in the raw data chunk cache.
	 * 
	 * @param plist       IN: Identifier of the file access property list.
	 * @param mdc_nelmts  IN: No longer used, will be ignored.
	 * @param rdcc_nelmts IN: Number of elements (objects) in the raw data chunk
	 *                    cache.
	 ...
	 * @exception HDF5LibraryException - Error from the HDF-5 Library.
	 **/
	public synchronized static native int H5Pset_cache(int plist, int mdc_nelmts, long rdcc_nelmts, long rdcc_nbytes,
			double rdcc_w0) throws HDF5LibraryException;

	public synchronized static native int H5Pget_char_encoding(int plist_id) throws HDF5LibraryException;

	public synchronized static native void H5Pset_char_encoding(int plist_id, int encoding) throws HDF5LibraryException;
	 ...
	 **/
	public synchronized static native int H5Pget_chunk(int plist, int max_ndims, long[] dims)
			throws HDF5LibraryException, NullPointerException, IllegalArgumentException;
	 ...
	 **/
	public synchronized static native int H5Pset_chunk(int plist, int ndims, byte[] dim)
			throws HDF5LibraryException, NullPointerException, IllegalArgumentException;
	 ...
	 * Retrieves the maximum possible number of elements in the meta data cache and
	 * the maximum possible number of bytes and the RDCC_W0 value in the raw data
	 * chunk cache on a per-datset basis.
	 * 
	 * @param dapl_id     IN: Identifier of the dataset access property list.
	 * @param rdcc_nslots IN/OUT: Number of elements (objects) in the raw data chunk
	 *                    cache.
	 * @param rdcc_nbytes IN/OUT: Total size of the raw data chunk cache, in bytes.
	 * @param rdcc_w0     IN/OUT: Preemption policy.
	 * 
	 ...
	 * @exception NullPointerException - an array is null.
	 **/
	public synchronized static native void H5Pget_chunk_cache(int dapl_id, long[] rdcc_nslots, long[] rdcc_nbytes,
			double[] rdcc_w0) throws HDF5LibraryException, NullPointerException;

	/**
	 * H5Pset_chunk_cache sets the number of elements (objects) in the meta data
	 * cache and the total number of bytes in the raw data chunk cache on a
	 * per-datset basis.
	 * 
	 * @param dapl_id     IN: Identifier of the datset access property list.
	 * @param rdcc_nslots IN: Number of elements (objects) in the raw data chunk
	 *                    cache.
	 * @param rdcc_nbytes IN: Total size of the raw data chunk cache, in bytes.
	 * @param rdcc_w0     IN: Preemption policy.
	 * 
	 * @exception HDF5LibraryException - Error from the HDF-5 Library.
	 **/
	public synchronized static native void H5Pset_chunk_cache(int dapl_id, long rdcc_nslots, long rdcc_nbytes,
			double rdcc_w0) throws HDF5LibraryException;

	/**
	 * H5Pget_class returns the property list class for the property list identified
	 * by the plist parameter.
	 * 
	 * @param plist IN: Identifier of property list to query.
	 * @return a property list class if successful. Otherwise returns H5P_NO_CLASS
	 *         (-1).
	 * 
	 * @exception HDF5LibraryException - Error from the HDF-5 Library.
	 **/
	public synchronized static native int H5Pget_class(int plist) throws HDF5LibraryException;
	...
	/**
	 * H5Pget_copy_object retrieves the properties to be used when an object is
	 * copied.
	 * 
	 ...
	 * 
	 **/
	public synchronized static native int H5Pget_copy_object(int ocp_plist_id) throws HDF5LibraryException;
	...
	/**
	 * H5Pget_create_intermediate_group determines whether property is set to enable
	 * creating missing intermediate groups.
	 * 
	 * @param lcpl_id IN: Link creation property list identifier
	 * 
	 ...
	 * 
	 **/
	public synchronized static native boolean H5Pget_create_intermediate_group(int lcpl_id) throws HDF5LibraryException;

	/**
	 * H5Pset_create_intermediate_group specifies in property list whether to create
	 * missing intermediate groups
	 * 
	 * @param lcpl_id            IN: Link creation property list identifier
	 * @param crt_intermed_group IN: Flag specifying whether to create intermediate
	 *                           groups upon the creation of an object
	 * 
	 * @return a non-negative valule if successful; otherwise returns a negative
	 *         value.
	 * 
	 * @exception HDF5LibraryException - Error from the HDF-5 Library.
	 * 
	...
	/**
	 * H5Pget_data_transform retrieves the data transform expression previously set
	 ...
	 * 
	 * @return The size of the transform expression if successful; 0(zero) if no
	 *         transform expression exists. Otherwise returns a negative value.
	 * 
	 * 
	 * @exception HDF5LibraryException     - Error from the HDF-5 Library.
	 ...
	 * with the file access property list or data transfer property list plid.
	 * 
	 * @param plid IN: File access or data transfer property list identifier.
	 * @return a valid low-level driver identifier if successful; a negative value
	 *         if failed
	 * @throws HDF5LibraryException
	 */
	public synchronized static native int H5Pget_driver(int plid) throws HDF5LibraryException;

	public synchronized static native int H5Pget_edc_check(int plist) throws HDF5LibraryException, NullPointerException;

	public synchronized static native int H5Pset_edc_check(int plist, int check)
			throws HDF5LibraryException, NullPointerException;

	/**
	 * H5Pget_elink_acc_flags retrieves the external link traversal file access flag
	 ...
	 * 
	 **/
	public synchronized static native int H5Pget_elink_acc_flags(int lapl_id) throws HDF5LibraryException;

	/**
	 * H5Pset_elink_acc_flags Sets the external link traversal file access flag in a
	 ...
	 * associated with the link access property list.
	 * 
	 * @param lapl_id IN: Link access property list identifier
	 * 
	 * @return a non-negative value if successful; otherwise returns a negative
	...
	private synchronized static native int _H5Pget_elink_fapl(int lapl_id) throws HDF5LibraryException;
	 ...
	 * 
	 **/
	public synchronized static native int H5Pset_elink_fapl(int lapl_id, int fapl_id) throws HDF5LibraryException;

	/**
	 * H5Pget_elink_file_cache_size retrieves the size of the external link open
	 * file cache.
	 * 
	 * @param fapl_id IN: File access property list identifier
	 * 
	 ...
	 * 
	 **/
	public synchronized static native int H5Pget_elink_file_cache_size(int fapl_id) throws HDF5LibraryException;

	/**
	 * H5Pset_elink_file_cache_size sets the number of files that can be held open
	 * in an external link open file cache.
	 * 
	 * @param fapl_id  IN: File access property list identifier
	 ...
	 * 
	 * @return If successful, returns a non-negative value specifying the size in
	 *         bytes of the prefix without the NULL terminator; otherwise returns a
	 *         negative value.
	 * 
	 * @exception HDF5LibraryException - Error from the HDF-5 Library.
	...
	/**
	 * H5Pget_est_link_info Queries data required to estimate required local heap or
	 * object header size.
	 * 
	 * @param gcpl_id   IN: Group creation property list identifier
	 * @param link_info Estimated number of links to be inserted into group And the
	...
	*      link_info[1] =  Estimated average length of link names
	...
	/**
	 * H5Pset_est_link_info Sets estimated number of links and length of link names
	 * in a group.
	 * 
	 * @param gcpl_id         IN: Group creation property list identifier
	 * @param est_num_entries IN: Estimated number of links to be inserted into
	 *                        group
	 ...
	 * 
	 * @exception HDF5LibraryException     - Error from the HDF-5 Library.
	 * @exception IllegalArgumentException - Invalid values to est_num_entries and
	 *                                     est_name_len.
	 * 
	 **/
	 ...
	 * @param size      OUT: the offset value and the size of the external file
	 *                  data.
	 * 
	 *                  <pre>
	 ...
	 * 
	 **/
	public synchronized static native int H5Pget_external(int plist, int idx, long name_size, String[] name,
	 ...
	 * @param offset IN: Offset, in bytes, from the beginning of the file to the
	 ...
	 * @exception NullPointerException - name is null.
	 **/
	public synchronized static native int H5Pset_external(int plist, String name, long offset, long size)
			throws HDF5LibraryException, NullPointerException;

	/**
	 * H5Pget_external_count returns the number of external files for the specified
	 * dataset.
	 * 
	 * @param plist IN: Identifier of a dataset creation property list.
	 * 
	 ...
	 * @exception HDF5LibraryException - Error from the HDF-5 Library.
	 **/
	public synchronized static native int H5Pget_external_count(int plist) throws HDF5LibraryException;
	...
	public synchronized static native void H5Pget_fapl_core(int fapl_id, long[] increment, boolean[] backing_store)
			throws HDF5LibraryException, NullPointerException;

	public synchronized static native int H5Pset_fapl_core(int fapl_id, long increment, boolean backing_store)
			throws HDF5LibraryException, NullPointerException;
	 ...
	 * 
	 * @param fapl_id IN: File access property list identifier
	 * @param info    OUT: Returned property list information info[0] = alignment
	 *                Required memory alignment boundary info[1] = block_size File
	 *                system block size info[2] = cbuf_size Copy buffer size
	 * 
	 * @return a non-negative value if successful; otherwise returns a negative
	 *         value.
	 * 
	 ...
	 * 
	 **/
	public synchronized static native int H5Pset_fapl_direct(int fapl_id, long alignment, long block_size,
...
//herr_t H5Pset_fapl_mpiposix( int fapl_id, MPI_Comm comm, hbool_t use_gpfs_hints ) 
	 ...
	 *                  (zero) to HADDR_MAX, at which each type of data storage
	 *                  begins.
	 * 
	 * @return a boolean value; Allows read-only access to incomplete file sets when
	 *         TRUE.
	 * 
	 * @exception HDF5LibraryException - Error from the HDF-5 Library.
	 * @exception NullPointerException - an array is null.
	 * 
	 **/
	public synchronized static native boolean H5Pget_fapl_multi(int fapl_id, int[] memb_map, int[] memb_fapl,
	 ...
	 *                  (zero) to HADDR_MAX, at which each type of data storage
	 *                  begins.
	 * @param relax     IN: Allows read-only access to incomplete file sets when
	 *                  TRUE.
	 * 
	 * @exception HDF5LibraryException - Error from the HDF-5 Library.
	 * @exception NullPointerException - an array is null.
	 * 
	 **/
	public synchronized static native void H5Pset_fapl_multi(int fapl_id, int[] memb_map, int[] memb_fapl,
	 ...
	 * 
	 **/
	public synchronized static int H5Pget_fill_value(int plist_id, int type_id, Object obj) throws HDF5Exception {
		HDFArray theArray = new HDFArray(obj);
		byte[] buf = theArray.emptyBytes();
	 ...
	 **/
	public synchronized static native int H5Pset_fill_value(int plist_id, int type_id, byte[] value)
			throws HDF5Exception;
	 ...
	 * @exception HDF5Exception - Error converting data array
	 **/
	public synchronized static int H5Pset_fill_value(int plist_id, int type_id, Object obj) throws HDF5Exception {
		HDFArray theArray = new HDFArray(obj);
		byte[] buf = theArray.byteify();
	 ...
	 * number, in a filter pipeline, specified by the property list with which it is
	 * associated.
	 * 
	 * @deprecated As of HDF5 1.8, replaced by
	 ...
	 * @param filter_number IN: Sequence number within the filter pipeline of the
	 *                      filter for which information is sought.
	 * @param flags         OUT: Bit vector specifying certain general properties of
	 *                      the filter.
	 ...
	 **/
	@Deprecated
	public synchronized static native int H5Pget_filter(int plist, int filter_number, int[] flags, int[] cd_nelmts,
			int[] cd_values, int namelen, String[] name)
			throws ArrayIndexOutOfBoundsException, ArrayStoreException, HDF5LibraryException, NullPointerException;
	 ...
	 * 
	 **/
	public static int H5Pget_filter(int plist, int filter_number, int[] flags, long[] cd_nelmts, int[] cd_values,
	 ...
	 * associated.
	 * 
	 * @see public static int H5Pget_filter(int plist, int filter_number, int[]
	 *      flags, int[] cd_nelmts, int[] cd_values, int namelen, String[] name,
	 *      int[] filter_config)
	 * 
	 **/
	private synchronized static native int H5Pget_filter2(int plist, int filter_number, int[] flags, long[] cd_nelmts,
			int[] cd_values, long namelen, String[] name, int[] filter_config)
			throws ArrayIndexOutOfBoundsException, ArrayStoreException, HDF5LibraryException, NullPointerException;

	/**
	 * H5Pset_filter adds the specified filter and corresponding properties to the
	 * end of an output filter pipeline.
	 * 
	 * @param plist     IN: Property list identifier.
	 * @param filter    IN: Filter to be added to the pipeline.
	 * @param flags     IN: Bit vector specifying certain general properties of the
	 *                  filter.
	 ...
	 * @exception HDF5LibraryException - Error from the HDF-5 Library.
	 **/
	public synchronized static native int H5Pset_filter(int plist, int filter, int flags, long cd_nelmts,
			int[] cd_values) throws HDF5LibraryException;

	/**
	 * H5Pget_filter_by_id returns information about the filter specified in
	 * filter_id, a filter identifier. plist_id must be a dataset or group creation
	 * property list and filter_id must be in the associated filter pipeline. The
	 * filter_id and flags parameters are used in the same manner as described in
	 * the discussion of H5Pset_filter. Aside from the fact that they are used for
	 * output, the parameters cd_nelmts and cd_values[] are used in the same manner
	 * as described in the discussion of H5Pset_filter. On input, the cd_nelmts
	 * parameter indicates the number of entries in the cd_values[] array allocated
	 * by the calling program; on exit it contains the number of values defined by
	 * the filter. On input, the namelen parameter indicates the number of
	 * characters allocated for the filter name by the calling program in the array
	 * name[]. On exit name[] contains the name of the filter with one character of
	 * the name in each element of the array. If the filter specified in filter_id
	 ...
	 **/
	@Deprecated
	public synchronized static native int H5Pget_filter_by_id(int plist_id, int filter_id, int[] flags,
	 ...
	 * @param namelen       IN: Anticipated number of characters in name.
	 * @param name          OUT: Name of the filter.
	 * @param filter_config OUT: A bit field encoding the returned filter
	 *                      information
	 * 
	 * @return the filter identification number if successful. Otherwise returns
	 *         H5Z_FILTER_ERROR (-1).
	 ...
	 * 
	 **/
	public static int H5Pget_filter_by_id(int plist_id, int filter_id, int[] flags, long[] cd_nelmts, int[] cd_values,
			long namelen, String[] name, int[] filter_config)
			throws ArrayIndexOutOfBoundsException, ArrayStoreException, HDF5LibraryException, NullPointerException {
	...
	/**
	 * H5Pget_filter_by_id2 returns information about a filter, specified by its
	 * filter id, in a filter pipeline, specified by the property list with which it
	 * is associated.
	 * 
	 * @see #H5Pget_filter_by_id
	 **/
	public synchronized static native int H5Pget_filter_by_id2(int plist_id, int filter_id, int[] flags,
			long[] cd_nelmts, int[] cd_values, long namelen, String[] name, int[] filter_config)
			throws HDF5LibraryException, NullPointerException;

	/**
	 * H5Pget_gc_references Returns the current setting for the garbage collection
	 * refernces property from a file access property list.
	 * <p>
	 * Note: this routine changed name with HDF5.1.2.2. If using an earlier version,
	 * use 'configure --enable-hdf5_1_2_1' so this routine will link to the old
	 * name.
	 * 
	 ...
	 **/
	public synchronized static native int H5Pget_gc_references(int fapl_id, boolean[] gc_ref)
			throws HDF5LibraryException, NullPointerException;

	public synchronized static native boolean H5Pget_gcreferences(int fapl_id) throws HDF5LibraryException;

	/*
	 * Earlier versions of the HDF5 library had a different name. This is included
	 * as an alias.
	 */
	public synchronized static int H5Pget_gc_reference(int fapl_id, boolean[] gc_ref)
			throws HDF5LibraryException, NullPointerException {
		return H5Pget_gc_references(fapl_id, gc_ref);
	}

	/**
	 * H5Pset_gc_references Sets the flag for garbage collecting references for the
	 * file. Default value for garbage collecting references is off.
	 * 
	 * @param fapl_id IN File access property list
	 ...
	 * @exception HDF5LibraryException - Error from the HDF-5 Library.
	 **/
	public synchronized static native int H5Pset_gc_references(int fapl_id, boolean gc_ref) throws HDF5LibraryException;
	...
	/**
	 * H5Pset_istore_k sets the size of the parameter used to control the B-trees
	 ...
	 * @exception HDF5LibraryException - Error from the HDF-5 Library.
	 **/
	public synchronized static native int H5Pset_istore_k(int plist, int ik) throws HDF5LibraryException;
	 ...
	 * @param plist IN: Identifier for property list to query.
	 * 
	 * @return the layout type of a dataset creation property list if successful.
	 *         Otherwise returns H5D_LAYOUT_ERROR (-1).
	 * 
	 * @exception HDF5LibraryException - Error from the HDF-5 Library.
	 **/
	public synchronized static native int H5Pget_layout(int plist) throws HDF5LibraryException;
	 ...
	 * @exception HDF5LibraryException - Error from the HDF-5 Library.
	 **/
	public synchronized static native int H5Pset_layout(int plist, int layout) throws HDF5LibraryException;

	/**
	 * H5Pget_libver_bounds retrieves the lower and upper bounds on the HDF5 Library
	 * versions that indirectly determine the object formats versions used when
	 * creating objects in the file.
	 * 
	 * @param fapl_id IN: File access property list identifier
	 * @param libver  The earliest/latest version of the library that will be used
	 *                for writing objects.
	 *
	 *                <pre>
	...
	*      libver[1] =  The latest version of the library that will be used for writing objects.
	...
	/**
	 * H5Pset_libver_bounds Sets bounds on library versions, and indirectly format
	...
	/**
	 * H5Pget_link_creation_order queries the group creation property list, gcpl_id,
	 * and returns a flag indicating whether link creation order is tracked and/or
	 * indexed in a group.
	 * 
	 * @param gcpl_id IN: Group creation property list identifier
	 * 
	 ...
	 * 
	 **/
	public synchronized static native int H5Pget_link_creation_order(int gcpl_id) throws HDF5LibraryException;
	...
	/**
	 * H5Pget_link_phase_change Queries the settings for conversion between compact
	 * and dense groups.
	 * 
	 * @param gcpl_id IN: Group creation property list identifier
	 * @param links   The max. no. of compact links & the min. no. of dense links,
	...
	*      links[1] =  The minimum number of links for dense storage
	...
	/**
	 * H5Pset_link_phase_change Sets the parameters for conversion between compact
	 * and dense groups.
	 * 
	 * @param gcpl_id     IN: Group creation property list identifier
	 * @param max_compact IN: Maximum number of links for compact storage(Default:
	 *                    8)
	 ...
	 * 
	 * @exception HDF5LibraryException     - Error from the HDF-5 Library.
	 * @exception IllegalArgumentException - Invalid values of max_compact and
	 *                                     min_dense.
	 * 
	 **/
	...
	/**
	 * H5Pget_local_heap_size_hint Retrieves the anticipated size of the local heap
	 ...
	 * 
	 **/
	public synchronized static native long H5Pget_local_heap_size_hint(int gcpl_id) throws HDF5LibraryException;

	/**
	 * H5Pset_local_heap_size_hint Specifies the anticipated maximum size of a local
	 * heap.
	 * 
	 * @param gcpl_id   IN: Group creation property list identifier
	...
	/**
	 * H5Pget_mdc_config gets the initial metadata cache configuration contained in
	 * a file access property list and loads it into the instance of
	 * H5AC_cache_config_t pointed to by the config_ptr parameter. This
	 * configuration is used when the file is opened.
	 * 
	 * @param plist_id IN: Identifier of the file access property list.
	 * 
	 * @return A buffer(H5AC_cache_config_t) for the current metadata cache
	 *         configuration information
	 * 
	 * @exception HDF5LibraryException - Error from the HDF-5 Library.
	 **/
	public synchronized static native H5AC_cache_config_t H5Pget_mdc_config(int plist_id) throws HDF5LibraryException;
	 ...
	 * 
	 **/
	public synchronized static native long H5Pget_meta_block_size(int fapl_id) throws HDF5LibraryException;
	 ...
	 * 
	 **/
	public synchronized static native void H5Pset_meta_block_size(int fapl_id, long size) throws HDF5LibraryException;

	/**
	 * H5Pget_nfilters returns the number of filters defined in the filter pipeline
	 * associated with the property list plist.
	 * 
	 * @param plist IN: Property list identifier.
	 * 
	 ...
	 * @exception HDF5LibraryException - Error from the HDF-5 Library.
	 **/
	public synchronized static native int H5Pget_nfilters(int plist) throws HDF5LibraryException;

	/**
	 * H5Pget_nlinks retrieves the maximum number of soft or user-defined link
	 * traversals allowed, nlinks, before the library assumes it has found a cycle
	 * and aborts the traversal. This value is retrieved from the link access
	 ...
	 * 
	 **/
	public synchronized static native long H5Pget_nlinks(int lapl_id) throws HDF5LibraryException;

	/**
	 * H5Pset_nlinks sets the maximum number of soft or user-defined link traversals
	 * allowed, nlinks, before the library assumes it has found a cycle and aborts
	 * the traversal. This value is set in the link access property list lapl_id.
	 * 
	 * @param lapl_id IN: File access property list identifier
	 ...
	 * 
	 * @deprecated As of HDF5 1.8, compound datatype field preservation is now core
	 *             functionality in the HDF5 Library.
	 * 
	 ...
	 **/
	@Deprecated
	public synchronized static native int H5Pget_preserve(int plist) throws HDF5LibraryException;
	 ...
	 **/
	@Deprecated
	public synchronized static native int H5Pset_preserve(int plist, boolean status)
			throws HDF5LibraryException, IllegalArgumentException;

	/**
	 * H5Pget_obj_track_times queries the object creation property list, ocpl_id, to
	 * determine whether object times are being recorded.
	 * 
	 * @param ocpl_id IN: Object creation property list identifier
	 * 
	 ...
	 * 
	 **/
	public synchronized static native boolean H5Pget_obj_track_times(int ocpl_id) throws HDF5LibraryException;

	/**
	 * H5Pset_obj_track_times sets a property in the object creation property list,
	 * ocpl_id, that governs the recording of times associated with an object.
	 * 
	 * @param ocpl_id     IN: Object creation property list identifier
	 * 
	 * @param track_times IN: TRUE or FALSE, specifying whether object times are to
	 *                    be tracked
	 * 
	 * @exception HDF5LibraryException - Error from the HDF-5 Library.
	 * 
	...
	/**
	 * H5Pget_shared_mesg_index Retrieves the configuration settings for a shared
	 * message index.
	 * 
	 * @param fcpl_id   IN: File creation property list identifier
	 * @param index_num IN: Index being configured.
	 * @param mesg_info The message type and minimum message size
	 *
	 *                  <pre>
	...
	*      mesg_info[1] =  Minimum message size.
	...
	/**
	 * H5Pset_shared_mesg_index Configures the specified shared object header
	 * message index
	 * 
	 * @param fcpl_id         IN: File creation property list identifier.
	 * @param index_num       IN: Index being configured.
	 * @param mesg_type_flags IN: Types of messages that should be stored in this
	 *                        index.
	...
	/**
	 * H5Pget_shared_mesg_nindexes retrieves number of shared object header message
	 * indexes in file creation property list.
	 * 
	 * @param fcpl_id IN: : File creation property list identifier
	 *
	 * @return nindexes, the number of shared object header message indexes
	 *         available in files created with this property list
	 * 
	 * @exception HDF5LibraryException - Error from the HDF-5 Library.
	 * 
	 **/
	public synchronized static native int H5Pget_shared_mesg_nindexes(int fcpl_id) throws HDF5LibraryException;

	/**
	 * H5Pset_shared_mesg_nindexes sets the number of shared object header message
	 * indexes in the specified file creation property list.
	 * 
	...
	/**
	 * H5Pget_shared_mesg_phase_change retrieves shared object header message phase
	 * change information.
	 * 
	 * @param fcpl_id IN: : File creation property list identifier
	 * @param size    The threshold values for storage of shared object header
	...
	*      size[1] =  Threshold below which storage of a shared object header message index reverts to list format
	...
	/**
	 * H5Pset_shared_mesg_phase_change sets shared object header message storage
	 * phase change thresholds.
	 * 
	 * @param fcpl_id   IN: File creation property list identifier
	 * @param max_list  IN: Threshold above which storage of a shared object header
	 *                  message index shifts from list to B-tree
	 * @param min_btree IN: Threshold below which storage of a shared object header
	 ...
	 * 
	 * @exception HDF5LibraryException     - Error from the HDF-5 Library.
	 * @exception IllegalArgumentException - Invalid values of max_list and
	 *                                     min_btree.
	 * 
	 **/
	...
	public synchronized static native long H5Pget_sieve_buf_size(int fapl_id) throws HDF5LibraryException;

	public synchronized static native void H5Pset_sieve_buf_size(int fapl_id, long size) throws HDF5LibraryException;
	...
	/**
	 * H5Pget_sizes retrieves the size of the offsets and lengths used in an HDF5
	 * file. This function is only valid for file creation property lists.
	 * 
	 * @param plist IN: Identifier of property list to query.
	...
	/**
	 * H5Pset_sizes sets the byte size of the offsets and lengths used to address
	 ...
	 * @exception HDF5LibraryException - Error from the HDF-5 Library.
	 **/
	public synchronized static native int H5Pset_sizes(int plist, int sizeof_addr, int sizeof_size)
			throws HDF5LibraryException;

	/**
	 * H5Pget_small_data_block_size retrieves the size of a block of small data in a
	...
	public synchronized static native long H5Pget_small_data_block_size_long(int plist) throws HDF5LibraryException;
	...
	/**
	 * H5Pget_sym_k retrieves the size of the symbol table B-tree 1/2 rank and the
	 * symbol table leaf node 1/2 size.
	 * 
	 * @param plist IN: Property list to query.
	 * @param size  OUT: the symbol table's B-tree 1/2 rank and leaf node 1/2size.
	 * 
	 *              <pre>
	 ...
	 * @exception HDF5LibraryException - Error from the HDF-5 Library.
	 **/
	public synchronized static native int H5Pset_sym_k(int plist, int ik, int lk) throws HDF5LibraryException;
	 ...
	 * @exception HDF5LibraryException - Error from the HDF-5 Library.
	 **/
	public synchronized static native int H5Pset_userblock(int plist, long size) throws HDF5LibraryException;
	 ...
	 *                     </pre>
	 * 
	 * @return a non-negative value, with the values of version_info initialized, if
	 *         successful
	 * 
	 * @exception HDF5LibraryException     - Error from the HDF-5 Library.
	...
	/**
	 * H5Pisa_class checks to determine whether a property list is a member of the
	 * specified class
	 * 
	 ...
	 * @throws HDF5LibraryException
	 */
	public synchronized static native int H5Pisa_class(int plist, int pclass) throws HDF5LibraryException;

	public synchronized static native int H5Pmodify_filter(int plist, int filter, int flags, long cd_nelmts,
	 ...
	 * @exception HDF5LibraryException - Error from the HDF-5 Library.
	 **/
	public synchronized static native int H5Pset_deflate(int plist, int level) throws HDF5LibraryException;

	/**
	 * H5Pset_fapl_log Sets up the logging virtual file driver (H5FD_LOG) for use.
	 * H5Pset_fapl_log modifies the file access property list to use the logging
	 * driver, H5FD_LOG. The logging virtual file driver (VFD) is a clone of the
	 * standard SEC2 (H5FD_SEC2) driver with additional facilities for logging VFD
	 * metrics and activity to a file.
	 *
	 * @deprecated As of HDF5 1.8.7, replaced by
	 *             {@link #H5Pset_fapl_log(int, String, long, long)}
	 *
	 * @param fapl_id  IN: File access property list identifier.
	 * @param logfile  IN: logfile is the name of the file in which the logging
	 ...
	 * @exception NullPointerException - logfile is null.
	 **/
	public synchronized static native void H5Pset_fapl_log(int fapl_id, String logfile, long flags, long buf_size)
			throws HDF5LibraryException, NullPointerException;

	public synchronized static native int H5Pset_fapl_sec2(int fapl_id)
			throws HDF5LibraryException, NullPointerException;

	public synchronized static native void H5Pset_fapl_split(int fapl_id, String meta_ext, int meta_plist_id,
			String raw_ext, int raw_plist_id) throws HDF5LibraryException, NullPointerException;
	 ...
	 * 
	 **/
	public synchronized static native int H5Pset_nbit(int plist_id) throws HDF5LibraryException;
...
//////////////////////////////////////////////////////////////
	...
	private synchronized static native int H5Rcreate(byte[] ref, int loc_id, String name, int ref_type, int space_id)
			throws HDF5LibraryException, NullPointerException, IllegalArgumentException;
	 ...
	 * 
	 * @param loc_id   IN: Location identifier used to locate the object being
	 *                 pointed to.
	 ...
	 **/
	public synchronized static byte[] H5Rcreate(int loc_id, String name, int ref_type, int space_id)
			throws HDF5LibraryException, NullPointerException, IllegalArgumentException {
	...
	/**
	 * Given a reference to some object, H5Rdereference opens that object and return
	 * an identifier.
	 * 
	...
	private synchronized static native int _H5Rdereference(int dataset, int ref_type, byte[] ref)
			throws HDF5LibraryException, NullPointerException, IllegalArgumentException;

	/**
	 * H5Rget_name retrieves a name for the object identified by ref.
	 * 
	 * @param loc_id   IN: Identifier for the dataset containing the reference or
	 *                 for the group that dataset is in.
	 * @param ref_type IN: Type of reference.
	 * @param ref      IN: An object or dataset region reference.
	 * @param name     OUT: A name associated with the referenced object or dataset
	 *                 region.
	 ...
	 * replaced in Release 1.6 by the function H5Rget_obj_type public synchronized
	 * static native int H5Rget_object_type(int loc_id, byte ref[]) throws
	 * HDF5LibraryException, NullPointerException, IllegalArgumentException;
	 */
	/**
	 * Given a reference to an object ref, H5Rget_obj_type returns the type of the
	 * object pointed to.
	 * 
	 * @deprecated As of HDF5 1.8, replaced by
	 *             {@link #H5Rget_obj_type(int, int, byte[], int[]) }
	 * 
	...
	/**
	 * H5Rget_obj_type Given a reference to an object ref, H5Rget_obj_type returns
	 ...
	 * 
	 * @return Returns the object type, which is the same as obj_type[0]. The return
	 *         value is the same as the HDF5 1.6 version.
	 * 
	 * @exception HDF5LibraryException     - Error from the HDF-5 Library.
	 * @exception NullPointerException     - array is null.
	 * @exception IllegalArgumentException - array is invalid.
	 **/
	public static int H5Rget_obj_type(int loc_id, int ref_type, byte ref[], int[] obj_type)
			throws HDF5LibraryException, NullPointerException, IllegalArgumentException {
		return H5Rget_obj_type2(loc_id, ref_type, ref, obj_type);
	}

	/**
	 * H5Rget_obj_type2 Retrieves the type of object that an object reference points
	 * to.
	 * 
	 * @see public static int H5Rget_obj_type(int loc_id, int ref_type, byte ref[],
	 *      int [] obj_type)
	 **/
	private synchronized static native int H5Rget_obj_type2(int loc_id, int ref_type, byte ref[], int[] obj_type)
			throws HDF5LibraryException, NullPointerException, IllegalArgumentException;

	/**
	 * Given a reference to an object ref, H5Rget_region creates a copy of the
	 * dataspace of the dataset pointed to and defines a selection in the copy which
	 * is the region pointed to.
	 * 
	 * @param loc_id   IN: loc_id of the reference object.
	 * @param ref_type IN: The reference type of ref.
	...
	private synchronized static native int _H5Rget_region(int loc_id, int ref_type, byte[] ref)
			throws HDF5LibraryException, NullPointerException, IllegalArgumentException;
...
//////////////////////////////////////////////////////////////
	...
	private synchronized static native int _H5Sclose(int space_id) throws HDF5LibraryException;
	...
	private synchronized static native int _H5Scopy(int space_id) throws HDF5LibraryException;
	...
	private synchronized static native int _H5Screate(int type) throws HDF5LibraryException;
	...
	private synchronized static native int _H5Screate_simple(int rank, long[] dims, long[] maxdims)
			throws HDF5Exception, NullPointerException;
	...
	/**
	 * H5Sdecode reconstructs the HDF5 data space object and returns a new object
	 * handle for it.
	 *
	 ...
	 * @exception NullPointerException - buf is null.
	 **/
	public synchronized static native int H5Sdecode(byte[] buf) throws HDF5LibraryException, NullPointerException;
	 ...
	 * @exception HDF5LibraryException - Error from the HDF-5 Library.
	 **/
	public synchronized static native byte[] H5Sencode(int obj_id) throws HDF5LibraryException, NullPointerException;

	/**
	 * H5Sextent_copy copies the extent from source_space_id to dest_space_id. This
	 * action may change the type of the dataspace.
	 * 
	 * @param dest_space_id   IN: The identifier for the dataspace from which the
	 *                        extent is copied.
	 * @param source_space_id IN: The identifier for the dataspace to which the
	 *                        extent is copied.
	 * 
	 * @return a non-negative value if successful
	 * 
	 * @exception HDF5LibraryException - Error from the HDF-5 Library.
	 **/
	public synchronized static native int H5Sextent_copy(int dest_space_id, int source_space_id)
			throws HDF5LibraryException;
	 ...
	 * 
	 * @param first_space_id  IN: The identifier for the first dataspace.
	 * @param second_space_id IN: The identifier for the seconddataspace.
	 * 
	 * @return true if successful, else false
	 * 
	 * @exception HDF5LibraryException - Error from the HDF-5 Library.
	 **/
	public synchronized static native boolean H5Sextent_equal(int first_space_id, int second_space_id)
			throws HDF5LibraryException;

	/**
	 * H5Sget_select_bounds retrieves the coordinates of the bounding box containing
	 * the current selection and places them into user-supplied buffers.
	 * <P>
	 ...
	 **/
	public synchronized static native int H5Sget_select_bounds(int spaceid, long[] start, long[] end)
			throws HDF5LibraryException, NullPointerException;
	 ...
	 * @exception HDF5LibraryException - Error from the HDF-5 Library.
	 **/
	public synchronized static native long H5Sget_select_elem_npoints(int spaceid) throws HDF5LibraryException;
	 ...
	 * @param buf        returns points startblock to startblock+num-1, each points
	 *                   is <i>rank</i> longs.
	 * 
	 * @return a non-negative value if successful
	 * 
	 ...
	 * @exception NullPointerException - buf is null.
	 **/
	public synchronized static native int H5Sget_select_elem_pointlist(int spaceid, long startpoint, long numpoints,
			long[] buf) throws HDF5LibraryException, NullPointerException;

	/**
	 * H5Sget_select_hyper_blocklist returns an array of hyperslab blocks. The block
	 * coordinates have the same dimensionality (rank) as the dataspace they are
	 * located within. The list of blocks is formatted as follows:
	 * 
	 * <pre>
	 ...
	 * @param buf        returns blocks startblock to startblock+num-1, each block
	 *                   is <i>rank</i> * 2 (corners) longs.
	 * 
	 * @return a non-negative value if successful
	 * 
	 * @exception HDF5LibraryException - Error from the HDF-5 Library.
	 * @exception NullPointerException - buf is null.
	 **/
	public synchronized static native int H5Sget_select_hyper_blocklist(int spaceid, long startblock, long numblocks,
			long[] buf) throws HDF5LibraryException, NullPointerException;
	 ...
	 * @exception HDF5LibraryException - Error from the HDF-5 Library.
	 **/
	public synchronized static native long H5Sget_select_hyper_nblocks(int spaceid) throws HDF5LibraryException;
	 ...
	 * @exception HDF5LibraryException - Error from the HDF-5 Library.
	 **/
	public synchronized static native long H5Sget_select_npoints(int space_id) throws HDF5LibraryException;

	/**
	 * H5Sget_select_type retrieves the type of selection currently defined for the
	 * dataspace space_id.
	 * 
	 * @param space_id IN: Identifier of the dataspace object to query
	 * 
	 ...
	 * @exception HDF5LibraryException - Error from the HDF-5 Library.
	 **/
	public synchronized static native int H5Sget_select_type(int space_id) throws HDF5LibraryException;
	 ...
	 * @exception HDF5LibraryException - Error from the HDF-5 Library.
	 **/
	public synchronized static native int H5Sget_simple_extent_ndims(int space_id) throws HDF5LibraryException;
	 ...
	 * @exception HDF5LibraryException - Error from the HDF-5 Library.
	 **/
	public synchronized static native long H5Sget_simple_extent_npoints(int space_id) throws HDF5LibraryException;

	/**
	 * H5Sget_simple_extent_type queries a dataspace to determine the current class
	 * of a dataspace.
	 * 
	 ...
	 * @exception HDF5LibraryException - Error from the HDF-5 Library.
	 **/
	public synchronized static native int H5Sget_simple_extent_type(int space_id) throws HDF5LibraryException;
	 ...
	 * @exception HDF5LibraryException - Error from the HDF-5 Library.
	 **/
	public synchronized static native boolean H5Sis_simple(int space_id) throws HDF5LibraryException;
	 ...
	 **/
	public synchronized static native int H5Soffset_simple(int space_id, byte[] offset)
			throws HDF5LibraryException, NullPointerException;
	 ...
	 * @exception HDF5LibraryException - Error from the HDF-5 Library.
	 **/
	public synchronized static native int H5Sselect_all(int space_id) throws HDF5LibraryException;

	/**
	 * H5Sselect_elements selects array elements to be included in the selection for
	 * the space_id dataspace.
	 * 
	 ...
	 * @param coord        A 2-dimensional array specifying the coordinates of the
	 *                     elements.
	 * 
	 * @return a non-negative value if successful
	 * 
	 * @exception HDF5LibraryException - Error from the HDF-5 Library.
	 **/
	private synchronized static native int H5Sselect_elements(int space_id, int op, int num_elements, byte[] coord)
			throws HDF5LibraryException, NullPointerException;
	 ...
	 * @param op           operator specifying how the new selection is combined.
	 * @param num_elements Number of elements to be selected.
	 * @param coord2D      A 2-dimensional array specifying the coordinates of the
	 *                     elements.
	 * 
	 * @return a non-negative value if successful
	 * 
	 ...
	 **/
	public synchronized static int H5Sselect_elements(int space_id, int op, int num_elements, long[][] coord2D)
			throws HDF5Exception, HDF5LibraryException, NullPointerException {
		if (coord2D == null) {
			return -1;
		}
...
//  throws HDF5LibraryException, NullPointerException;
	...
	/**
	 * H5Sselect_hyperslab selects a hyperslab region to add to the current selected
	 * region for the dataspace specified by space_id. The start, stride, count, and
	 * block arrays must be the same size as the rank of the dataspace.
	 * 
	 * @param space_id IN: Identifier of dataspace selection to modify
	 * @param op       IN: Operation to perform on current selection.
	 * @param start    IN: Offset of start of hyperslab
	 ...
	 **/
	public synchronized static int H5Sselect_hyperslab(int space_id, int op, byte[] start, byte[] stride, byte[] count,
			byte[] block) throws HDF5LibraryException, NullPointerException, IllegalArgumentException {
	...
	public synchronized static native int H5Sselect_hyperslab(int space_id, int op, long[] start, long[] stride,
	 ...
	 * @exception HDF5LibraryException - Error from the HDF-5 Library.
	 **/
	public synchronized static native int H5Sselect_none(int space_id) throws HDF5LibraryException;

	/**
	 * H5Sselect_valid verifies that the selection for the dataspace.
	 * 
	 * @param space_id The identifier for the dataspace in which the selection is
	 *                 being reset.
	 * 
	 * @return true if the selection is contained within the extent and FALSE if it
	 *         is not or is an error.
	 * 
	 * @exception HDF5LibraryException - Error from the HDF-5 Library.
	 **/
	public synchronized static native boolean H5Sselect_valid(int space_id) throws HDF5LibraryException;

	/**
	 * H5Sset_extent_none removes the extent from a dataspace and sets the type to
	 * H5S_NONE.
	 * 
	 * @param space_id The identifier for the dataspace from which the extent is to
	 *                 be removed.
	 * 
	 * @return a non-negative value if successful
	 * 
	 * @exception HDF5LibraryException - Error from the HDF-5 Library.
	 **/
	public synchronized static native int H5Sset_extent_none(int space_id) throws HDF5LibraryException;
	 ...
	 * @exception HDF5LibraryException - Error from the HDF-5 Library.
	 **/
	public synchronized static native int H5Sset_extent_simple(int space_id, int rank, long[] current_size,
			long[] maximum_size) throws HDF5LibraryException, NullPointerException;

	public synchronized static int H5Sset_extent_simple(int space_id, int rank, byte[] current_size,
...
//////////////////////////////////////////////////////////////
	 ...
	 *
	 * @deprecated As of HDF5 1.8, replaced by
	 *             {@link #H5Tarray_create(int, int, long[])}
	 *
	 ...
	 **/
	@Deprecated
	public static int H5Tarray_create(int base, int rank, int[] dims, int[] perms)
			throws HDF5LibraryException, NullPointerException {
	...
	private synchronized static native int _H5Tarray_create(int base, int rank, int[] dims, int[] perms)
			throws HDF5LibraryException, NullPointerException;
	...
	private synchronized static native int _H5Tclose(int type_id) throws HDF5LibraryException;

	/**
	 * H5Tcommit commits a transient datatype (not immutable) to a file, turned it
	 * into a named datatype.
	 * 
	 * @deprecated As of HDF5 1.8, replaced by
	 *             {@link #H5Tcommit(int, String, int, int, int, int)}
	 *
	 * @param loc_id  IN: Location identifier.
	 ...
	 **/
	@Deprecated
	public static int H5Tcommit(int loc_id, String name, int type_id)
			throws HDF5LibraryException, NullPointerException {
		return H5Tcommit1(loc_id, name, type_id);
	}

	@Deprecated
	public synchronized static native int H5Tcommit1(int loc_id, String name, int type)
			throws HDF5LibraryException, NullPointerException;

	/**
	 * H5Tcommit saves a transient datatype as an immutable named datatype in a
	 * file.
	 *
	 * @param loc_id  IN: Location identifier.
	 * @param name    IN: Name given to committed datatype.
	 ...
	 * @exception NullPointerException - name is null.
	 **/
	public synchronized static native void H5Tcommit(int loc_id, String name, int type_id, int lcpl_id, int tcpl_id,
			int tapl_id) throws HDF5LibraryException, NullPointerException;

	/**
	 * H5Tcommit_anon commits a transient datatype (not immutable) to a file,
	 * turning it into a named datatype with the specified creation and property
	 * lists.
	 *
	 * @param loc_id  IN: Location identifier.
	 * @param type_id IN: Identifier of datatype to be committed.
	...
	/**
	 * H5Tcommitted queries a type to determine whether the type specified by the
	 * type identifier is a named type or a transient type.
	 * 
	 ...
	 * @exception HDF5LibraryException - Error from the HDF-5 Library.
	 **/
	public synchronized static native boolean H5Tcommitted(int type_id) throws HDF5LibraryException;
	 ...
	 * @exception HDF5LibraryException - Error from the HDF-5 Library.
	 **/
	public synchronized static native void H5Tcompiler_conv(int src_id, int dst_id) throws HDF5LibraryException;

	/**
	 ** H5Tconvert converts nelmts elements from the type specified by the src_id
	 * identifier to type dst_id.
	 *
	 * @param src_id     IN: Identifier of source datatype.
	 * @param dst_id     IN: Identifier of destination datatype.
	...
	public synchronized static native void H5Tconvert(int src_id, int dst_id, long nelmts, byte[] buf,
			byte[] background, int plist_id) throws HDF5LibraryException, NullPointerException;
//  int H5Tconvert(int src_id, int dst_id, long nelmts, Pointer buf, Pointer background, int plist_id);

	/**
	 * H5Tcopy copies an existing datatype. The returned type is always transient
	 * and unlocked.
	 *
	...
	private synchronized static native int _H5Tcopy(int type_id) throws HDF5LibraryException;
	...
	private synchronized static native int _H5Tcreate(int type, long size) throws HDF5LibraryException;

	/**
	 * H5Tdecode reconstructs the HDF5 data type object and returns a new object
	 * handle for it.
	 *
	 ...
	 * @exception NullPointerException - buf is null.
	 **/
	public synchronized static native int H5Tdecode(byte[] buf) throws HDF5LibraryException, NullPointerException;
	 ...
	 *
	 * @return true if the datatype specified in dtype_id contains any datatypes of
	 *         the datatype class
	 *
	 * @exception HDF5LibraryException - Error from the HDF-5 Library.
	 **/
	public synchronized static native boolean H5Tdetect_class(int type_id, int cls) throws HDF5LibraryException;

	/**
	 * H5Tencode converts a data type description into binary form in a buffer.
	 *
	 * @param obj_id IN: Identifier of the object to be encoded.
	 * @param buf    OUT: Buffer for the object to be encoded into. If the provided
	 *               buffer is NULL, only the size of buffer needed is returned.
...
//throws HDF5LibraryException;
	...
	/**
	 * H5Tenum_create creates a new enumeration datatype based on the specified base
	 * datatype, parent_id, which must be an integer type.
	 * 
	...
	private synchronized static native int _H5Tenum_create(int base_id) throws HDF5LibraryException;

	/**
	 * H5Tenum_insert inserts a new enumeration datatype member into an enumeration
	 * datatype.
	 *
	 ...
	 * @exception NullPointerException - name is null.
	 **/
	public static int H5Tenum_insert(int type, String name, int[] value)
			throws HDF5LibraryException, NullPointerException {
	...
	private synchronized static native int H5Tenum_insert_int(int type, String name, int[] value)
			throws HDF5LibraryException, NullPointerException;
...
//int H5Tenum_nameof(int type, Pointer value, Buffer name/* out */, long size);
	...
	private synchronized static native int H5Tenum_nameof_int(int type, int[] value, String[] name, int size)
			throws HDF5LibraryException, NullPointerException;

	/**
	 * H5Tenum_valueof finds the value that corresponds to the specified name of the
	...
	private synchronized static native int H5Tenum_valueof_int(int type, String name, int[] value)
			throws HDF5LibraryException, NullPointerException;
	 ...
	 * @exception HDF5LibraryException - Error from the HDF-5 Library.
	 **/
	public synchronized static native boolean H5Tequal(int type_id1, int type_id2) throws HDF5LibraryException;

	/**
	 * H5Tget_array_dims returns the sizes of the dimensions of the specified array
	 * datatype object.
	 *
	 * @deprecated As of HDF5 1.8
	 *
	 ...
	 **/
	@Deprecated
	public synchronized static native int H5Tget_array_dims(int type_id, int[] dims, int[] perm)
			throws HDF5LibraryException, NullPointerException;
	 ...
	 *
	 * @deprecated As of HDF5 1.8, replaced by
	 *             {@link #H5Tget_array_dims(int, long[])}
	 *
	 * @param type_id IN: Datatype identifier of array object.
	 * @param dims    OUT: Sizes of array dimensions.
	...
	/**
	 * H5Tget_array_dims1 returns the sizes of the dimensions of the specified array
	 * datatype object.
	 *
	 * @deprecated As of HDF5 1.8, replaced by
	 *             {@link #H5Tget_array_dims2(int, long[])}
	 *
	 * @see public static int H5Tget_array_dims(int type_id, long[] dims, int[]
	 *      perm)
	 **/
	@Deprecated
	...
	/**
	 * H5Tget_array_dims2 returns the sizes of the dimensions of the specified array
	 * datatype object.
	 *
	...
	/**
	 * H5Tget_array_ndims returns the rank, the number of dimensions, of an array
	 * datatype object.
	 *
	 * @param type_id IN: Datatype identifier of array object.
	 *
	 ...
	 * @exception HDF5LibraryException - Error from the HDF-5 Library.
	 **/
	public synchronized static native int H5Tget_array_ndims(int type_id) throws HDF5LibraryException;
	 ...
	 * @exception HDF5LibraryException - Error from the HDF-5 Library.
	 **/
	public synchronized static native int H5Tget_create_plist(int type_id) throws HDF5LibraryException;
	 ...
	 * @exception HDF5LibraryException - Error from the HDF-5 Library.
	 **/
	public synchronized static native int H5Tget_cset(int type_id) throws HDF5LibraryException;
	 ...
	 * @exception HDF5LibraryException - Error from the HDF-5 Library.
	 **/
	public synchronized static native int H5Tset_cset(int type_id, int cset) throws HDF5LibraryException;
	 ...
	 * @exception HDF5LibraryException - Error from the HDF-5 Library.
	 **/
	public synchronized static native int H5Tget_ebias(int type_id) throws HDF5LibraryException;
	 ...
	 * @exception HDF5LibraryException - Error from the HDF-5 Library.
	 **/
	public synchronized static native long H5Tget_ebias_long(int type_id) throws HDF5LibraryException;
	 ...
	 * @exception HDF5LibraryException - Error from the HDF-5 Library.
	 **/
	public synchronized static native void H5Tset_ebias(int type_id, long ebias) throws HDF5LibraryException;

	/**
	 * H5Tget_fields retrieves information about the locations of the various bit
	 * fields of a floating point datatype.
	 *
	 * @param type_id IN: Identifier of datatype to query.
	 * @param fields  OUT: location of size and bit-position.
	 *                <ul>
	 *                <li>fields[0] = spos OUT: location to return size of in
	 *                bits.</li>
	 *                <li>fields[1] = epos OUT: location to return exponent
	 *                bit-position.</li>
	 *                <li>fields[2] = esize OUT: location to return size of exponent
	 *                in bits.</li>
	 *                <li>fields[3] = mpos OUT: location to return mantissa
	 *                bit-position.</li>
	 *                <li>fields[4] = msize OUT: location to return size of mantissa
	 *                in bits.</li>
	 *                </ul>
	 *
	 * @exception HDF5LibraryException     - Error from the HDF-5 Library.
	...
	private synchronized static native int H5Tget_fields_int(int type_id, int[] fields)
			throws HDF5LibraryException, NullPointerException, IllegalArgumentException;

	/**
	 * H5Tset_fields sets the locations and sizes of the various floating point bit
	 * fields.
	 *
	 * @param type_id IN: Identifier of datatype to set.
	 ...
	 * @exception HDF5LibraryException - Error from the HDF-5 Library.
	 **/
	public synchronized static native void H5Tset_fields(int type_id, long spos, long epos, long esize, long mpos,
	 ...
	 * @exception HDF5LibraryException - Error from the HDF-5 Library.
	 **/
	public synchronized static native int H5Tget_inpad(int type_id) throws HDF5LibraryException;

	/**
	 * If any internal bits of a floating point type are unused (that is, those
	 * significant bits which are not part of the sign, exponent, or mantissa), then
	 * H5Tset_inpad will be filled according to the value of the padding value
	 * property inpad.
	 * 
	 * @param type_id IN: Identifier of datatype to modify.
	 ...
	 * @exception HDF5LibraryException - Error from the HDF-5 Library.
	 **/
	public synchronized static native int H5Tset_inpad(int type_id, int inpad) throws HDF5LibraryException;
	 ...
	 * @exception HDF5LibraryException - Error from the HDF-5 Library.
	 **/
	public synchronized static native int H5Tget_member_class(int type_id, int membno) throws HDF5LibraryException;
	...
	/**
	 * H5Tget_member_name retrieves the name of a field of a compound datatype or an
	 * element of an enumeration datatype.
	 * 
	 * @param type_id   IN: Identifier of datatype to query.
	...
	/**
	 * H5Tget_member_offset returns the byte offset of the specified member of the
	 * compound datatype. This is the byte offset in the HDF-5 file/library, NOT the
	 * offset of any Java object which might be mapped to this data item.
	 * 
	 * @param type_id IN: Identifier of datatype to query.
	 ...
	 * @exception HDF5LibraryException - Error from the HDF-5 Library.
	 **/
	public synchronized static native long H5Tget_member_offset(int type_id, int membno) throws HDF5LibraryException;
	...
	private synchronized static native int _H5Tget_member_type(int type_id, int field_idx) throws HDF5LibraryException;
	...
	private synchronized static native int H5Tget_member_value_int(int type_id, int membno, int[] value)
			throws HDF5LibraryException, NullPointerException;

	/**
	 * H5Tget_native_type returns the equivalent native datatype for the datatype
	 * specified in type_id.
	 *
	 * @param type_id IN: Identifier of datatype to query. Direction of search is
	 ...
	 * @exception HDF5LibraryException - Error from the HDF-5 Library.
	 **/
	public synchronized static int H5Tget_native_type(int type_id) throws HDF5LibraryException {
	...
	private synchronized static native int _H5Tget_native_type(int tid, int direction) throws HDF5LibraryException;
	 ...
	 * @exception HDF5LibraryException - Error from the HDF-5 Library.
	 **/
	public synchronized static native int H5Tget_nmembers(int type_id) throws HDF5LibraryException;
	 ...
	 * @exception HDF5LibraryException - Error from the HDF-5 Library.
	 **/
	public synchronized static native int H5Tget_norm(int type_id) throws HDF5LibraryException;
	 ...
	 * @exception HDF5LibraryException - Error from the HDF-5 Library.
	 **/
	public synchronized static native int H5Tset_norm(int type_id, int norm) throws HDF5LibraryException;
	 ...
	 * @exception HDF5LibraryException - Error from the HDF-5 Library.
	 **/
	public synchronized static native int H5Tget_offset(int type_id) throws HDF5LibraryException;
	 ...
	 * @exception HDF5LibraryException - Error from the HDF-5 Library.
	 **/
	public synchronized static native void H5Tset_offset(int type_id, long offset) throws HDF5LibraryException;
	 ...
	 * @exception HDF5LibraryException - Error from the HDF-5 Library.
	 **/
	public synchronized static native int H5Tget_order(int type_id) throws HDF5LibraryException;
	 ...
	 * @exception HDF5LibraryException - Error from the HDF-5 Library.
	 **/
	public synchronized static native int H5Tset_order(int type_id, int order) throws HDF5LibraryException;

	/**
	 * H5Tget_pad retrieves the padding type of the least and most-significant bit
	 * padding.
	 * 
	 * @param type_id IN: Identifier of datatype to query.
	 ...
	 * @exception HDF5LibraryException - Error from the HDF-5 Library.
	 **/
	public synchronized static native int H5Tset_pad(int type_id, int lsb, int msb) throws HDF5LibraryException;
	 ...
	 * @exception HDF5LibraryException - Error from the HDF-5 Library.
	 **/
	public synchronized static native int H5Tget_precision(int type_id) throws HDF5LibraryException;
	 ...
	 * @exception HDF5LibraryException - Error from the HDF-5 Library.
	 **/
	public synchronized static native long H5Tget_precision_long(int type_id) throws HDF5LibraryException;
	 ...
	 * @exception HDF5LibraryException - Error from the HDF-5 Library.
	 **/
	public synchronized static native void H5Tset_precision(int type_id, long precision) throws HDF5LibraryException;
	 ...
	 * @exception HDF5LibraryException - Error from the HDF-5 Library.
	 **/
	public synchronized static native int H5Tget_sign(int type_id) throws HDF5LibraryException;
	 ...
	 * @exception HDF5LibraryException - Error from the HDF-5 Library.
	 **/
	public synchronized static native int H5Tset_sign(int type_id, int sign) throws HDF5LibraryException;
	...
	/**
	 * H5Tset_size sets the total size in bytes, size, for an atomic datatype (this
	 * operation is not permitted on compound datatypes).
	 * 
	 ...
	 * @exception HDF5LibraryException - Error from the HDF-5 Library.
	 **/
	public synchronized static native long H5Tget_size_long(int type_id) throws HDF5LibraryException;
	 ...
	 * @exception HDF5LibraryException - Error from the HDF-5 Library.
	 **/
	public synchronized static native void H5Tset_size(int type_id, long size) throws HDF5LibraryException;
	 ...
	 * @exception HDF5LibraryException - Error from the HDF-5 Library.
	 **/
	public synchronized static native int H5Tget_strpad(int type_id) throws HDF5LibraryException;
	 ...
	 * @exception HDF5LibraryException - Error from the HDF-5 Library.
	 **/
	public synchronized static native int H5Tset_strpad(int type_id, int strpad) throws HDF5LibraryException;
	...
	private synchronized static native int _H5Tget_super(int type) throws HDF5LibraryException;
	 ...
	 * @exception HDF5LibraryException - Error from the HDF-5 Library.
	 **/
	public synchronized static native String H5Tget_tag(int type) throws HDF5LibraryException;
	 ...
	 * @param tag  IN: Descriptive ASCII string with which the opaque datatype is to
	 *             be tagged.
	 * 
	 * @return a non-negative value if successful
	 * 
	 * @exception HDF5LibraryException - Error from the HDF-5 Library.
	 **/
	public synchronized static native int H5Tset_tag(int type, String tag) throws HDF5LibraryException;
	 ...
	 * @exception NullPointerException - name is null.
	 **/
	public synchronized static native int H5Tinsert(int type_id, String name, long offset, int field_id)
			throws HDF5LibraryException, NullPointerException;

	/**
	 * H5Tis_variable_str determines whether the datatype identified in type_id is a
	 ...
	 * @exception HDF5LibraryException - Error from the HDF-5 Library.
	 **/
	public synchronized static native boolean H5Tis_variable_str(int type_id) throws HDF5LibraryException;
	 ...
	 * @exception HDF5LibraryException - Error from the HDF-5 Library.
	 **/
	public synchronized static native int H5Tlock(int type_id) throws HDF5LibraryException;

	/**
	 * H5Topen opens a named datatype at the location specified by loc_id and return
	 * an identifier for the datatype.
	 *
	 * @deprecated As of HDF5 1.8, replaced by {@link #H5Topen(int, String, int)}
	 *
	 * @param loc_id IN: A file, group, or datatype identifier.
	 * @param name   IN: A datatype name, defined within the file or group
	...
	/**
	 * H5Tpack recursively removes padding from within a compound datatype to make
	 * it more efficient (space-wise) to store that data.
	 * <P>
	 * <b>WARNING:</b> This call only affects the C-data, even if it succeeds, there
	 * may be no visible effect on Java objects.
	 * 
	 * @param type_id IN: Identifier of datatype to modify.
	 * 
	 * @return a non-negative value if successful
	 ...
	 * @exception HDF5LibraryException - Error from the HDF-5 Library.
	 **/
	public synchronized static native int H5Tpack(int type_id) throws HDF5LibraryException;
	...
	private synchronized static native int _H5Tvlen_create(int base_id) throws HDF5LibraryException;
